...
const RAW = {
	...
	/** Printer with a sheet coming out — the worksheet export. */
	printer: {
		d: 'M7 9V4.5h10V9 M7 17.5H5.5a1 1 0 0 1-1-1V10a1 1 0 0 1 1-1h13a1 1 0 0 1 1 1v6.5a1 1 0 0 1-1 1H17 M7 14.5h10v5H7v-5Z',
		fill: 'M16.5 11a.9.9 0 1 1 0 1.8.9.9 0 0 1 0-1.8Z'
	},
	words: {
