...
final QuizContent enDeM7Predicate = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'The film is exciting. (spannend)', answer: 'Der Film ist **spannend**'),
    CourseItem(prompt: 'The soup tastes good. (gut)', answer: 'Die Suppe schmeckt **gut**'),
    CourseItem(prompt: 'The weather stays beautiful. (schön)', answer: 'Das Wetter bleibt **schön**'),
    CourseItem(prompt: 'The shoes are expensive. (teuer)', answer: 'Die Schuhe sind **teuer**'),
    CourseItem(prompt: 'The garden is big. (groß)', answer: 'Der Garten ist **groß**'),
    CourseItem(prompt: 'The music is loud. (laut)', answer: 'Die Musik ist **laut**'),
    CourseItem(prompt: 'The bread stays fresh. (frisch)', answer: 'Das Brot bleibt **frisch**'),
    CourseItem(prompt: 'The night is dark. (dunkel)', answer: 'Die Nacht ist **dunkel**'),
    CourseItem(prompt: 'The exercise is easy. (leicht)', answer: 'Die Übung ist **leicht**'),
    CourseItem(prompt: 'The dog is hungry. (hungrig)', answer: 'Der Hund ist **hungrig**'),
  ],
);
...
final QuizContent enDeM7DerNom = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'the strong coffee (Nom)', answer: 'der **starke** Kaffee'),
    CourseItem(prompt: 'the fresh bread (Nom)', answer: 'das **frische** Brot'),
    CourseItem(prompt: 'the beautiful city (Nom)', answer: 'die **schöne** Stadt'),
    ...
    CourseItem(prompt: 'the old books (Nom, pl)', answer: 'die **alten** Bücher'),
    CourseItem(prompt: 'the warm soup (Nom)', answer: 'die **warme** Suppe'),
    CourseItem(prompt: 'the green garden (Nom)', answer: 'der **grüne** Garten'),
  ],
);
...
final QuizContent enDeM7DerAkk = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'I drink the strong coffee. (Akk)', answer: 'Ich trinke den **starken** Kaffee'),
    CourseItem(prompt: 'I take the fast train. (Akk)', answer: 'Ich nehme den **schnellen** Zug'),
    CourseItem(prompt: 'I visit the beautiful city. (Akk)', answer: 'Ich besuche die **schöne** Stadt'),
    CourseItem(prompt: 'I wear the warm jacket. (Akk)', answer: 'Ich trage die **warme** Jacke'),
    CourseItem(prompt: 'I open the big window. (Akk)', answer: 'Ich öffne das **große** Fenster'),
    CourseItem(prompt: 'I love the green garden. (Akk)', answer: 'Ich liebe den **grünen** Garten'),
    CourseItem(prompt: 'I hear the loud music. (Akk)', answer: 'Ich höre die **laute** Musik'),
    CourseItem(prompt: 'I feed the hungry dog. (Akk)', answer: 'Ich füttere den **hungrigen** Hund'),
    CourseItem(prompt: 'I buy the old books. (Akk, pl)', answer: 'Ich kaufe die **alten** Bücher'),
    CourseItem(prompt: 'I eat the hot soup. (Akk)', answer: 'Ich esse die **heiße** Suppe'),
  ],
);
...
final QuizContent enDeM7EinNom = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'a strong coffee (Nom)', answer: 'ein **starker** Kaffee'),
    CourseItem(prompt: 'a beautiful city (Nom)', answer: 'eine **schöne** Stadt'),
    CourseItem(prompt: 'a fresh bread (Nom)', answer: 'ein **frisches** Brot'),
    CourseItem(prompt: 'my young brother (Nom)', answer: 'mein **junger** Bruder'),
    ...
    CourseItem(prompt: 'my new bike (Nom, das Fahrrad)', answer: 'mein **neues** Fahrrad'),
  ],
);
...
final QuizContent enDeM7Dictation = enDeDict(
  ...
  items: const [
    ...
    CourseItem(prompt: 'I drink the strong coffee.', answer: 'Ich trinke den starken Kaffee.'),
    CourseItem(prompt: 'a nice woman', answer: 'eine nette Frau'),
    CourseItem(prompt: 'the fresh bread', answer: 'das frische Brot'),
    CourseItem(prompt: 'I take the fast train.', answer: 'Ich nehme den schnellen Zug.'),
    CourseItem(prompt: 'my small dog', answer: 'mein kleiner Hund'),
    CourseItem(prompt: 'the young woman', answer: 'die junge Frau'),
    CourseItem(prompt: 'I love my new apartment.', answer: 'Ich liebe meine neue Wohnung.'),
