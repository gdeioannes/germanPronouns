...
final QuizContent enDeM13Praeteritum = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'müssen → had to (ich)', answer: 'musste'),
    CourseItem(prompt: 'wollen → wanted (ich)', answer: 'wollte'),
    CourseItem(prompt: 'nehmen → took (ich)', answer: 'nahm'),
    CourseItem(prompt: 'finden → found (ich)', answer: 'fand'),
    CourseItem(prompt: 'essen → ate (ich)', answer: 'aß', accepted: ['ass']),
    CourseItem(prompt: 'schreiben → wrote (ich)', answer: 'schrieb'),
    CourseItem(prompt: 'wissen → knew (ich)', answer: 'wusste'),
  ],
);
