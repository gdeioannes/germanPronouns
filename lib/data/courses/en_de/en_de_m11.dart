...
final QuizContent enDeM11Coordinating = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'He cooks and she reads.', answer: 'Er kocht **und** sie liest'),
    CourseItem(prompt: 'We stay home, because it is raining. (denn)', answer: 'Wir bleiben zu Hause, **denn** es regnet'),
    CourseItem(prompt: 'Do we take the bus or the train?', answer: 'Nehmen wir den Bus **oder** den Zug?'),
    CourseItem(prompt: 'The film is long, but exciting.', answer: 'Der Film ist lang, **aber** spannend'),
    CourseItem(prompt: 'I drink tea and eat cake.', answer: 'Ich trinke Tee **und** esse Kuchen'),
    CourseItem(prompt: 'She is tired, because she worked a lot. (denn)', answer: 'Sie ist müde, **denn** sie hat viel gearbeitet'),
    CourseItem(prompt: 'Are you coming along, or are you staying here?', answer: 'Kommst du mit, **oder** bleibst du hier?'),
    CourseItem(prompt: 'He is nice, but a little shy.', answer: 'Er ist nett, **aber** etwas schüchtern'),
    CourseItem(prompt: 'I buy bread and she buys cheese.', answer: 'Ich kaufe Brot **und** sie kauft Käse'),
    CourseItem(prompt: 'We hurry, because the train leaves soon. (denn)', answer: 'Wir beeilen uns, **denn** der Zug fährt bald ab'),
  ],
);
...
final QuizContent enDeM11Weil = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'He takes the bus because it is raining.', answer: 'Er nimmt den Bus, weil es **regnet**'),
    CourseItem(prompt: 'She drinks tea because coffee is too strong.', answer: 'Sie trinkt Tee, weil Kaffee zu stark **ist**'),
    CourseItem(prompt: 'We are happy because the weekend is coming.', answer: 'Wir freuen uns, weil das Wochenende **kommt**'),
    CourseItem(prompt: 'I eat an apple because I am hungry.', answer: 'Ich esse einen Apfel, weil ich Hunger **habe**'),
    CourseItem(prompt: 'He sleeps because he is very tired.', answer: 'Er schläft, weil er sehr müde **ist**'),
    CourseItem(prompt: 'She saves money because she wants to travel.', answer: 'Sie spart Geld, weil sie reisen **will**'),
    CourseItem(prompt: 'We open the window because it is warm.', answer: 'Wir öffnen das Fenster, weil es warm **ist**'),
    CourseItem(prompt: 'I call you because I have a question.', answer: 'Ich rufe dich an, weil ich eine Frage **habe**'),
    CourseItem(prompt: 'They stay inside because it is cold.', answer: 'Sie bleiben drinnen, weil es kalt **ist**'),
    CourseItem(prompt: 'He learns a lot because he wants to pass the exam.', answer: 'Er lernt viel, weil er die Prüfung bestehen **will**'),
  ],
);
...
final QuizContent enDeM11Dass = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'I hope that the weather stays nice.', answer: 'Ich hoffe, dass das Wetter schön **bleibt**'),
    CourseItem(prompt: 'He believes that we are coming tomorrow.', answer: 'Er glaubt, dass wir morgen **kommen**'),
    CourseItem(prompt: 'She thinks that the film is boring.', answer: 'Sie findet, dass der Film langweilig **ist**'),
    CourseItem(prompt: 'We know that he works a lot.', answer: 'Wir wissen, dass er viel **arbeitet**'),
    CourseItem(prompt: 'I am glad that you are helping me.', answer: 'Ich freue mich, dass du mir **hilfst**'),
    CourseItem(prompt: 'It is a pity that she cannot come.', answer: 'Es ist schade, dass sie nicht kommen **kann**'),
    CourseItem(prompt: 'He says that the food tastes good.', answer: 'Er sagt, dass das Essen gut **schmeckt**'),
    CourseItem(prompt: 'I think that German is fun.', answer: 'Ich denke, dass Deutsch Spaß **macht**'),
    CourseItem(prompt: 'She hopes that the train comes on time.', answer: 'Sie hofft, dass der Zug pünktlich **kommt**'),
    CourseItem(prompt: 'We believe that you all can do it.', answer: 'Wir glauben, dass ihr das **könnt**'),
    CourseItem(prompt: 'I know that they live here.', answer: 'Ich weiß, dass sie hier **wohnen**'),
  ],
);
...
final QuizContent enDeM11Wenn = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'When the sun shines, we go to the park.', answer: 'Wenn die Sonne **scheint**, gehen wir in den Park'),
    CourseItem(prompt: 'If you are hungry, we eat now.', answer: 'Wenn du Hunger **hast**, essen wir jetzt'),
    CourseItem(prompt: 'When I am tired, I sleep.', answer: 'Wenn ich müde **bin**, schlafe ich'),
    CourseItem(prompt: 'If it snows, we stay home.', answer: 'Wenn es **schneit**, bleiben wir zu Hause'),
    CourseItem(prompt: 'When the weekend comes, we celebrate.', answer: 'Wenn das Wochenende **kommt**, feiern wir'),
    CourseItem(prompt: 'If you need help, call me.', answer: 'Wenn du Hilfe **brauchst**, ruf mich an'),
    CourseItem(prompt: 'When grandma visits, she bakes a cake.', answer: 'Wenn Oma zu Besuch **kommt**, backt sie einen Kuchen'),
    CourseItem(prompt: 'If the shop is open, I buy bread.', answer: 'Wenn das Geschäft offen **ist**, kaufe ich Brot'),
    CourseItem(prompt: 'When we have holidays, we travel.', answer: 'Wenn wir Ferien **haben**, verreisen wir'),
    CourseItem(prompt: 'If you all want, we play cards.', answer: 'Wenn ihr **wollt**, spielen wir Karten'),
    CourseItem(prompt: 'When the music plays, they dance.', answer: 'Wenn die Musik **spielt**, tanzen sie'),
  ],
);
...
final QuizContent enDeM11Dictation = enDeDict(
  ...
  items: const [
    ...
    CourseItem(prompt: 'We take the bus, because it is raining.', answer: 'Wir nehmen den Bus, denn es regnet.'),
    CourseItem(prompt: 'He learns German because he lives in Berlin.', answer: 'Er lernt Deutsch, weil er in Berlin wohnt.'),
    CourseItem(prompt: 'I hope that you are coming.', answer: 'Ich hoffe, dass du kommst.'),
    CourseItem(prompt: 'If you want, we can go.', answer: 'Wenn du willst, können wir gehen.'),
    CourseItem(prompt: 'Do you want tea or coffee?', answer: 'Möchtest du Tee oder Kaffee?'),
    CourseItem(prompt: 'She works and he cooks.', answer: 'Sie arbeitet und er kocht.'),
    CourseItem(prompt: 'I know that they live here.', answer: 'Ich weiß, dass sie hier wohnen.'),
    CourseItem(prompt: 'When the sun shines, we go out.', answer: 'Wenn die Sonne scheint, gehen wir raus.'),
    CourseItem(prompt: 'He is tired because he slept badly.', answer: 'Er ist müde, weil er schlecht geschlafen hat.'),
    CourseItem(prompt: 'It is a pity that she cannot come.', answer: 'Es ist schade, dass sie nicht kommen kann.'),
  ],
);
