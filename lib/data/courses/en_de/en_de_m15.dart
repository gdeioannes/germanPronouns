...
final QuizContent enDeM15Forms = enDeFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'she would (sie)', answer: 'sie **würde**'),
    CourseItem(prompt: 'we would be (wir)', answer: 'wir **wären**'),
    CourseItem(prompt: 'you would have (du)', answer: 'du **hättest**'),
    CourseItem(prompt: 'you all could (ihr)', answer: 'ihr **könntet**'),
    CourseItem(prompt: 'I would have to (müsste)', answer: 'ich **müsste**'),
    CourseItem(prompt: 'they would be (sie, pl)', answer: 'sie **wären**'),
    CourseItem(prompt: 'you would (du)', answer: 'du **würdest**'),
  ],
);
