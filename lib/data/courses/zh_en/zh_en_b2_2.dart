...
final QuizContent zhEnB22Reported = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '他说他住在郊区。', answer: 'He said he **lived** in the suburbs.'),
    CourseItem(prompt: '她说她已经做完了。', answer: 'She said she **had** finished.'),
    CourseItem(prompt: '他们说他们能来。', answer: 'They said they **could** come.'),
    CourseItem(prompt: '他说他第二天会去银行。', answer: 'He said he **would** go to the bank the next day.'),
    CourseItem(prompt: '她告诉我们她在学中文。', answer: 'She told us she **was** learning Chinese.'),
    CourseItem(prompt: '他说他从没去过美国。', answer: 'He said he **had** never been to America.'),
    CourseItem(prompt: '她说她那天很忙。（today→that day）', answer: 'She said she was busy **that** day.'),
    CourseItem(prompt: '他们说他们正在装修房子。', answer: 'They said they **were** decorating the house.'),
    CourseItem(prompt: '他告诉我他会考虑的。', answer: 'He told me he **would** think about it.'),
    CourseItem(prompt: '她说她把票丢了。', answer: 'She said she **had** lost the tickets.'),
  ],
);
...
final QuizContent zhEnB22ReportedQ = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '她问我从哪里来。', answer: 'She asked me where I **came** from.'),
    CourseItem(prompt: '他问我们是否准备好了。', answer: 'He asked **whether** we were ready.'),
    CourseItem(prompt: '老师让我们安静。', answer: 'The teacher told us **to** be quiet.'),
    CourseItem(prompt: '她叫他别担心。', answer: 'She told him **not** to worry.'),
    CourseItem(prompt: '他问我为什么迟到。', answer: 'He asked me why I **was** late.'),
    CourseItem(prompt: '她问我会不会开车。', answer: 'She asked me **if** I could drive.'),
    CourseItem(prompt: '他问火车什么时候出发。', answer: 'He asked when the train **left**.'),
    CourseItem(prompt: '医生叫他多休息。', answer: 'The doctor told him **to** rest more.'),
    CourseItem(prompt: '她叫孩子们别在街上玩。', answer: 'She told the children **not** to play in the street.'),
    CourseItem(prompt: '他们问我们要不要加入。', answer: 'They asked us **whether** we wanted to join.'),
  ],
);
...
final QuizContent zhEnB22ReportingVerbs = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '他主动提出开车送我们。', answer: 'He offered **to drive** us.'),
    CourseItem(prompt: '她建议休息一下。', answer: 'She suggested **taking** a break.'),
    CourseItem(prompt: '他们答应准时到。', answer: 'They promised **to arrive** on time.'),
    CourseItem(prompt: '他承认忘了钥匙。', answer: 'He admitted **forgetting** the keys.'),
    CourseItem(prompt: '她拒绝回答那个问题。', answer: 'She refused **to answer** that question.'),
    CourseItem(prompt: '他建议坐地铁去。', answer: 'He suggested **taking** the underground.'),
    CourseItem(prompt: '她答应不告诉任何人。', answer: 'She promised **not to tell** anyone.'),
    CourseItem(prompt: '他们主动提出付钱。', answer: 'They offered **to pay**.'),
    CourseItem(prompt: '他否认见过她。', answer: 'He denied **seeing** her.'),
    CourseItem(prompt: '她承认迟到了。', answer: 'She admitted **being** late.'),
  ],
);
...
final QuizContent zhEnB22Deduction = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '门开着，有人一定在办公室。', answer: 'Someone **must** be in the office; the door is open.'),
    CourseItem(prompt: '那不可能是他，他出国了。', answer: "That **can't** be him; he is abroad."),
    CourseItem(prompt: '她可能在路上。', answer: 'She **might** be on her way.'),
    CourseItem(prompt: '这一定很难。', answer: 'It **must** be very difficult.'),
    CourseItem(prompt: '他们可能不知道。', answer: 'They **may** not know.'),
    CourseItem(prompt: '她还在办公室？她一定在加班。', answer: 'Still at the office? She **must** be working late.'),
    CourseItem(prompt: '那个包不可能是她的，太旧了。', answer: "That bag **can't** be hers; it's too old."),
    CourseItem(prompt: '他可能在洗澡，没听见电话。', answer: 'He **might** be in the shower.'),
    CourseItem(prompt: '你们一定饿了，先吃点东西吧。', answer: 'You **must** be hungry — have something to eat.'),
    CourseItem(prompt: '这个价格不可能是对的。', answer: "This price **can't** be right."),
  ],
);
...
final QuizContent zhEnB22DeductionPast = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '她一定是走错路了。', answer: 'She **must** have taken the wrong road.'),
    CourseItem(prompt: '他不可能说过那句话。', answer: "He **can't** have said that."),
    CourseItem(prompt: '他们可能已经出发了。', answer: 'They **might** have already left.'),
    CourseItem(prompt: '你一定听错了。', answer: 'You **must** have misheard.'),
    CourseItem(prompt: '她可能没收到消息。', answer: 'She **might** not have got the message.'),
    CourseItem(prompt: '路是湿的，晚上一定下过雨。', answer: 'The road is wet — it **must** have rained last night.'),
    CourseItem(prompt: '他不可能已经到家了，太远了。', answer: "He **can't** have got home yet; it's too far."),
    CourseItem(prompt: '他们可能坐了早一班火车。', answer: 'They **might** have taken an earlier train.'),
    CourseItem(prompt: '她一定花了很多钱买这辆车。', answer: 'She **must** have spent a lot on this car.'),
    CourseItem(prompt: '我可能把地址写错了。', answer: 'I **might** have written the address wrong.'),
  ],
);
...
final QuizContent zhEnB22Nondefining = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '我们的老师（来自加拿大）很有耐心。', answer: 'Our teacher, **who** is from Canada, is very patient.'),
    CourseItem(prompt: '这家公司（成立于1990年）很有名。', answer: 'The company, **which** was founded in 1990, is famous.'),
    CourseItem(prompt: '我妹妹（在上海工作）下周回来。', answer: 'My sister, **who** works in Shanghai, is coming back next week.'),
    CourseItem(prompt: '这座公园（就在我家旁边）很漂亮。', answer: 'The park, **which** is next to my house, is beautiful.'),
    CourseItem(prompt: '王先生（我们的邻居）帮了大忙。', answer: 'Mr Wang, **who** is our neighbour, helped a lot.'),
    CourseItem(prompt: '这条河（穿过市中心）经常发洪水。', answer: 'The river, **which** runs through the city centre, often floods.'),
    CourseItem(prompt: '我的祖母（今年九十岁了）还每天散步。', answer: 'My grandmother, **who** is ninety, still walks every day.'),
    CourseItem(prompt: '这部手机（上个月才买的）已经坏了。', answer: 'The phone, **which** I bought only last month, has already broken.'),
    CourseItem(prompt: '张医生（在这里工作了二十年）下月退休。', answer: 'Dr Zhang, **who** has worked here for twenty years, retires next month.'),
    CourseItem(prompt: '这个节日（在秋天庆祝）历史悠久。', answer: 'The festival, **which** is celebrated in autumn, has a long history.'),
  ],
);
...
final QuizContent zhEnB22Phrasal = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '把它关掉。（代词放中间！）', answer: 'Turn it **off**.'),
    CourseItem(prompt: '把垃圾拿出去。', answer: 'Take the rubbish **out**.'),
    CourseItem(prompt: '她把帽子戴上了。', answer: 'She put her hat **on**.'),
    CourseItem(prompt: '把它写下来。', answer: 'Write it **down**.'),
    CourseItem(prompt: '他把提议拒绝了。', answer: 'He turned the offer **down**.'),
    CourseItem(prompt: '把它捡起来。（代词放中间！）', answer: 'Pick it **up**.'),
    CourseItem(prompt: '把灯打开。', answer: 'Turn the lights **on**.'),
    CourseItem(prompt: '别把它扔掉。（代词放中间！）', answer: "Don't throw it **away**."),
    CourseItem(prompt: '她把消息传了下去。', answer: 'She passed the message **on**.'),
    CourseItem(prompt: '我们把计划放弃了。（give up）', answer: 'We gave the plan **up**.'),
  ],
);
...
final QuizContent zhEnB22Causative = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '我们请人清洗了窗户。', answer: 'We had the windows **cleaned**.'),
    CourseItem(prompt: '他让人送来了披萨。', answer: 'He had a pizza **delivered**.'),
    CourseItem(prompt: '她把牙检查了一下。', answer: 'She had her teeth **checked**.'),
    CourseItem(prompt: '我要把这份文件翻译一下。（请人翻译）', answer: 'I need to get this document **translated**.'),
    CourseItem(prompt: '他们请人安装了空调。', answer: 'They had the air conditioner **installed**.'),
    CourseItem(prompt: '我得把这套西装干洗一下。', answer: 'I need to have this suit **cleaned**.'),
    CourseItem(prompt: '她昨天把护照照片拍好了。', answer: 'She had her passport photo **taken** yesterday.'),
    CourseItem(prompt: '我们下周请人检查锅炉。', answer: 'We are having the boiler **checked** next week.'),
    CourseItem(prompt: '他把手表修好了。（请人修）', answer: 'He got his watch **fixed**.'),
    CourseItem(prompt: '你多久剪一次头发？（请人剪）', answer: 'How often do you have your hair **cut**?'),
  ],
);
...
final QuizContent zhEnB22DictNews = zhEnDict(
  ...
  items: const [
    ...
    CourseItem(prompt: '她建议早点出发。', answer: 'She suggested leaving early.'),
    CourseItem(prompt: '他一定错过了公交车。', answer: 'He must have missed the bus.'),
    CourseItem(prompt: '他们让我等在外面。', answer: 'They told me to wait outside.'),
    CourseItem(prompt: '我要去理发。', answer: 'I am going to have my hair cut.'),
    CourseItem(prompt: '她问我是否需要帮助。', answer: 'She asked me if I needed help.'),
    CourseItem(prompt: '数百人被迫离开家园。', answer: 'Hundreds of people have been forced to leave their homes.'),
    CourseItem(prompt: '他拒绝发表评论。', answer: 'He refused to comment.'),
    CourseItem(prompt: '这座桥正在维修。', answer: 'The bridge is being repaired.'),
    CourseItem(prompt: '她可能没听到新闻。', answer: 'She might not have heard the news.'),
    CourseItem(prompt: '他问我什么时候回来。', answer: 'He asked me when I would come back.'),
  ],
);
...
final QuizContent zhEnB22Intensifiers = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '这条路快得多。', answer: 'This road is **much** faster.'),
    CourseItem(prompt: '考试比我预期的难一点。', answer: 'The exam was a **bit** harder than I expected.'),
    CourseItem(prompt: '这家酒店便宜得多。', answer: 'This hotel is a **lot** cheaper.'),
    CourseItem(prompt: '他的英语好得多了。', answer: 'His English is **much** better now.'),
    CourseItem(prompt: '今天人稍微少一点。', answer: 'It is **slightly** less crowded today.'),
    CourseItem(prompt: '这部电影比书有意思得多。', answer: 'The film is **far** more interesting than the book.'),
    CourseItem(prompt: '新办公室大一点点。', answer: 'The new office is **slightly** bigger.'),
    CourseItem(prompt: '这次考试比上次容易得多。', answer: 'This exam was **much** easier than the last one.'),
    CourseItem(prompt: '他今天感觉好一点了。', answer: 'He feels a **bit** better today.'),
    CourseItem(prompt: '网上购物便宜得多。', answer: 'Shopping online is a **lot** cheaper.'),
  ],
);
