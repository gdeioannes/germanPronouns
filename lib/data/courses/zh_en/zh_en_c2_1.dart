...
final QuizContent zhEnC21Modality = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '你本不该那么说的。', answer: "You **shouldn't** have said that."),
    CourseItem(prompt: '我们本可以赢的。', answer: 'We **could** have won.'),
    CourseItem(prompt: '你本不必买礼物的。', answer: "You **needn't** have bought a present."),
    CourseItem(prompt: '他本应该更小心。', answer: 'He **should** have been more careful.'),
    CourseItem(prompt: '她本可以成为一名律师。', answer: 'She **could** have become a lawyer.'),
    CourseItem(prompt: '我们本不必这么急的。', answer: "We **needn't** have hurried."),
    CourseItem(prompt: '你本可以问我的。', answer: 'You **could** have asked me.'),
    CourseItem(prompt: '他们本该早点通知我们。', answer: 'They **should** have informed us earlier.'),
    CourseItem(prompt: '换作别人早就放弃了。', answer: 'Anyone else **would** have given up.'),
    CourseItem(prompt: '她本不该独自去的。', answer: "She **shouldn't** have gone alone."),
  ],
);
...
final QuizContent zhEnC21Aspect = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '她一直在打扫，所以很累（强调过程）。', answer: "She's been **cleaning**, so she's tired."),
    CourseItem(prompt: '她已经打扫完了房子（强调结果）。', answer: 'She has **cleaned** the house.'),
    CourseItem(prompt: '到下个月他们就结婚二十年了。', answer: 'By next month, they will have been **married** for twenty years.'),
    CourseItem(prompt: '我这一周一直在见客户。', answer: "I've been **meeting** clients all week."),
    CourseItem(prompt: '到五点我就写完报告了。', answer: 'I will have **written** the report by five.'),
    CourseItem(prompt: '你一直在抽烟吗？我闻到烟味了。（过程留痕）', answer: 'Have you been **smoking**? I can smell it.'),
    CourseItem(prompt: '他们已经修好了路（结果）。', answer: 'They have **repaired** the road.'),
    CourseItem(prompt: '他们修路修了好几个月了（过程）。', answer: 'They have been **repairing** the road for months.'),
    CourseItem(prompt: '到十二月他就退休了。（将来完成）', answer: 'He will have **retired** by December.'),
    CourseItem(prompt: '雨已经下了三天了（还在下）。', answer: 'It has been **raining** for three days.'),
  ],
);
...
final QuizContent zhEnC21Ellipsis = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '我没去，但我本想去的。', answer: "I didn't go, but I wanted **to**."),
    CourseItem(prompt: '她会游泳，他也会。', answer: 'She can swim, and so **can** he.'),
    CourseItem(prompt: '他不喜欢，我也不喜欢。', answer: "He doesn't like it, and neither **do** I."),
    CourseItem(prompt: '「他通过了吗？」「恐怕没有。」', answer: "'Did he pass?' 'I'm afraid **not**.'"),
    CourseItem(prompt: '这支笔坏了，给我拿支新的。', answer: 'This pen is broken; get me a new **one**.'),
    CourseItem(prompt: '「你会告诉他吗？」「我想不会。」', answer: "'Will you tell him?' 'I suppose **not**.'"),
    CourseItem(prompt: '她比大多数人努力，也比大多数人成功。（too 收尾）', answer: 'She works harder than most, and succeeds more, **too**.'),
    CourseItem(prompt: '我没时间了，他也没有。', answer: "I have no time left, and neither **does** he."),
    CourseItem(prompt: '你可以留下来——如果你愿意的话。（to 替代）', answer: 'You can stay — if you want **to**.'),
    CourseItem(prompt: '他答应帮忙，也确实帮了。（did 替代）', answer: 'He promised to help, and he **did**.'),
  ],
);
...
final QuizContent zhEnC21Idioms = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '如坐针毡', answer: 'on pins and **needles**'),
    CourseItem(prompt: '守口如瓶', answer: 'to keep it under your **hat**'),
    CourseItem(prompt: '本末倒置', answer: 'to put the cart before the **horse**'),
    CourseItem(prompt: '雨过天晴，往事随风', answer: 'water under the **bridge**'),
    CourseItem(prompt: '孤注一掷', answer: 'to put all your eggs in one **basket**'),
    CourseItem(prompt: '直言不讳，打开天窗说亮话', answer: 'to call a spade a **spade**'),
    CourseItem(prompt: '事后诸葛亮（事后聪明）', answer: 'hindsight is twenty-**twenty**'),
    CourseItem(prompt: '进退两难', answer: 'between a rock and a hard **place**'),
    CourseItem(prompt: '锦上添花之外的惊喜（蛋糕上的糖霜）', answer: 'the icing on the **cake**'),
    CourseItem(prompt: '习惯成自然（第二天性）', answer: 'second **nature**'),
  ],
);
...
final QuizContent zhEnC21Connotation = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '他很吝啬（贬）。', answer: 'He is **stingy**.'),
    CourseItem(prompt: '她很自信（褒）。', answer: 'She is **confident**.'),
    CourseItem(prompt: '她很自大（贬）。', answer: 'She is **arrogant**.'),
    CourseItem(prompt: '一个好奇的孩子（褒）。', answer: 'a **curious** child'),
    CourseItem(prompt: '一个爱管闲事的邻居（贬）。', answer: 'a **nosy** neighbour'),
    CourseItem(prompt: '一个年轻气盛的经理（贬：不成熟）。', answer: 'an **immature** manager'),
    CourseItem(prompt: '一个朝气蓬勃的经理（褒）。', answer: 'an **energetic** manager'),
    CourseItem(prompt: '他很挑剔（贬）。', answer: 'He is **fussy**.'),
    CourseItem(prompt: '他很讲究（褒：注重细节）。', answer: 'He is **meticulous**.'),
    CourseItem(prompt: '一个天真的问题（可含贬义：naive）。', answer: 'a **naive** question'),
  ],
);
...
final QuizContent zhEnC21Marked = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '我确实警告过他们。', answer: 'I **did** warn them.'),
    CourseItem(prompt: '正是价格让顾客却步。', answer: 'It is the price that **puts** customers off.'),
    CourseItem(prompt: '他确实很努力，只是运气不好。', answer: 'He **does** work hard; he is just unlucky.'),
    CourseItem(prompt: '我们真心欢迎批评。', answer: 'We **do** welcome criticism.'),
    CourseItem(prompt: '正是细节决定成败。', answer: 'It is the details that **make** the difference.'),
    CourseItem(prompt: '我确实读了合同——每一个字。', answer: 'I **did** read the contract — every word.'),
    CourseItem(prompt: '正是他的沉默出卖了他。', answer: 'It was his silence that **gave** him away.'),
    CourseItem(prompt: '她确实道歉了，公开地。', answer: 'She **did** apologise, publicly.'),
    CourseItem(prompt: '我们确实考虑过风险。', answer: 'We **did** consider the risks.'),
    CourseItem(prompt: '正是这个词让整句话变了味。', answer: 'It is this word that **changes** the whole sentence.'),
  ],
);
...
final QuizContent zhEnC21PvNetworks = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '她把客人安顿在客房。', answer: 'She put the guests **up** in the spare room.'),
    CourseItem(prompt: '把你的名字写在名单上。', answer: 'Put your name **down** on the list.'),
    CourseItem(prompt: '他把成功归于运气。', answer: 'He put his success **down** to luck.'),
    CourseItem(prompt: '别再拖延了。', answer: 'Stop putting it **off**.'),
    CourseItem(prompt: '把海报贴起来。', answer: 'Put the poster **up**.'),
    CourseItem(prompt: '他用文字准确地表达了这种感觉。（put into words）', answer: 'He put the feeling **into** words.'),
    CourseItem(prompt: '把想法写下来，别只是空想。', answer: 'Put your ideas **down** on paper.'),
    CourseItem(prompt: '她把孩子们安顿睡下了。（put to bed）', answer: 'She put the children **to** bed.'),
    CourseItem(prompt: '我再也忍受不了他的态度了。', answer: "I can't put up **with** his attitude any longer."),
    CourseItem(prompt: '别贬低你自己。（put down）', answer: "Don't put yourself **down**."),
  ],
);
...
final QuizContent zhEnC21RegisterShift = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '正式：请您稍候。', answer: 'Would you kindly **wait** a moment?'),
    CourseItem(prompt: '非正式：没门儿。', answer: 'No **way**.'),
    CourseItem(prompt: '正式：恐怕我们无法同意。', answer: 'I am afraid we cannot **agree**.'),
    CourseItem(prompt: '非正式：搞定了。', answer: '**Done** and dusted.'),
    CourseItem(prompt: '正式：事宜已妥善处理。', answer: 'The matter has been **resolved**.'),
    CourseItem(prompt: '非正式：这主意烂透了。', answer: "That idea **stinks**."),
    CourseItem(prompt: '正式：该提议存在重大缺陷。', answer: 'The proposal is seriously **flawed**.'),
    CourseItem(prompt: '非正式：他溜了。', answer: 'He **took** off.'),
    CourseItem(prompt: '正式：他已提前离场。', answer: 'He **departed** early.'),
    CourseItem(prompt: '非正式：随便你。', answer: '**Suit** yourself.'),
  ],
);
...
final QuizContent zhEnC21CollocationPrecision = zhEnFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '交通繁忙', answer: 'heavy **traffic**'),
    CourseItem(prompt: '强烈的愿望', answer: 'a strong **desire**'),
    CourseItem(prompt: '滔天大错', answer: 'a grave **mistake**'),
    CourseItem(prompt: '一线希望', answer: 'a glimmer of **hope**'),
    CourseItem(prompt: '重感冒', answer: 'a bad **cold**'),
    CourseItem(prompt: '强风', answer: 'a strong **wind**'),
    CourseItem(prompt: '重罚', answer: 'a heavy **fine**'),
    CourseItem(prompt: '深刻的印象', answer: 'a lasting **impression**'),
    CourseItem(prompt: '激烈的竞争', answer: 'fierce **competition**'),
    CourseItem(prompt: '截然不同（天壤之别）', answer: 'worlds **apart**'),
  ],
);
...
final QuizContent zhEnC21DictNuance = zhEnDict(
  ...
  items: const [
    ...
    CourseItem(prompt: '很少有人质疑这一假设。', answer: 'Rarely has this assumption been questioned.'),
    CourseItem(prompt: '这个方案绝非完美，但值得一试。', answer: 'The plan is by no means perfect, but it is worth trying.'),
    CourseItem(prompt: '正是这种沉默让人担忧。', answer: 'It is this silence that worries people.'),
    CourseItem(prompt: '事实证明，谨慎是对的。', answer: 'Caution, as it turned out, was justified.'),
    CourseItem(prompt: '他本该三思而后行的。', answer: 'He should have thought twice before acting.'),
    CourseItem(prompt: '这个决定说好听点也是仓促的。', answer: 'The decision was hasty, to say the least.'),
    CourseItem(prompt: '我们从来没有得到过完整的解释。（否定倒装）', answer: 'Never have we been given a full explanation.'),
    CourseItem(prompt: '关键不在速度，而在方向。', answer: 'What counts is not speed but direction.'),
    CourseItem(prompt: '批评虽严厉，却并非没有道理。', answer: 'The criticism, though harsh, was not without merit.'),
    CourseItem(prompt: '要是当时多一点耐心，结果也许会不同。', answer: 'With a little more patience, the outcome might have been different.'),
  ],
);
