...
final QuizContent enZhB22Zhe = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'He is holding a bouquet of flowers.', answer: '他手里拿**着**一束花。', accepted: ['zhe'], hint: 'tā shǒu li ná zhe yí shù huā'),
    CourseItem(prompt: 'The window is (standing) open.', answer: '窗户开**着**。', accepted: ['zhe'], hint: 'chuānghu kāi zhe'),
    CourseItem(prompt: 'She listened standing. (stand-着 listen)', answer: '她站**着**听。', accepted: ['zhe'], hint: 'tā zhàn zhe tīng'),
    CourseItem(prompt: 'The wallet is sitting at home. (放着)', answer: '钱包在家里放**着**。', accepted: ['zhe'], hint: 'qiánbāo zài jiā li fàng zhe'),
    CourseItem(prompt: 'A few characters are written on the door. (写着)', answer: '门上写**着**几个字。', accepted: ['zhe'], hint: 'mén shàng xiě zhe jǐ ge zì'),
    CourseItem(prompt: 'He walked in carrying (背着) a bag.', answer: '他背**着**包走了进来。', accepted: ['zhe'], hint: 'tā bēi zhe bāo zǒu le jìnlái'),
    CourseItem(prompt: 'Don\'t talk while lying down. (躺着)', answer: '别躺**着**说话。', accepted: ['zhe'], hint: 'bié tǎng zhe shuōhuà'),
    CourseItem(prompt: 'The TV is on, but nobody is watching.', answer: '电视开**着**，可是没人看。', accepted: ['zhe'], hint: 'diànshì kāi zhe, kěshì méi rén kàn'),
    CourseItem(prompt: 'She listens to music while running. (一边 works too — here use V着V)', answer: '她听**着**音乐跑步。', accepted: ['zhe'], hint: 'tā tīng zhe yīnyuè pǎobù'),
  ],
);
...
final QuizContent enZhB22JiuCai = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'She finished the homework in ten minutes (that fast).', answer: '她十分钟**就**写完了作业。', accepted: ['jiù'], hint: 'tā shí fēnzhōng jiù xiě wán le zuòyè'),
    CourseItem(prompt: 'I only finished reading this book today.', answer: '这本书我今天**才**看完。', accepted: ['cái'], hint: 'zhè běn shū wǒ jīntiān cái kàn wán'),
    CourseItem(prompt: 'The child could speak at two already (early).', answer: '孩子两岁**就**会说话了。', accepted: ['jiù'], hint: 'háizi liǎng suì jiù huì shuōhuà le'),
    CourseItem(prompt: 'He only got home at midnight (late — no 了!).', answer: '他半夜**才**到家。', accepted: ['cái'], hint: 'tā bànyè cái dào jiā'),
    CourseItem(prompt: 'The shop is right nearby (that close). (就在)', answer: '商店**就**在旁边。', accepted: ['jiù'], hint: 'shāngdiàn jiù zài pángbiān'),
    CourseItem(prompt: 'I\'ll come right after I finish eating. (that soon)', answer: '我吃完饭**就**来。', accepted: ['jiù'], hint: 'wǒ chī wán fàn jiù lái'),
    CourseItem(prompt: 'He only started learning Chinese at forty (that late).', answer: '他四十岁**才**开始学中文。', accepted: ['cái'], hint: 'tā sìshí suì cái kāishǐ xué Zhōngwén'),
    CourseItem(prompt: 'She got it after reading twice (only then).', answer: '她看了两遍**才**懂。', accepted: ['cái'], hint: 'tā kàn le liǎng biàn cái dǒng'),
    CourseItem(prompt: 'We\'ll set off as soon as it\'s light. (天一亮…就)', answer: '天一亮，我们**就**出发。', accepted: ['jiù'], hint: 'tiān yí liàng, wǒmen jiù chūfā'),
  ],
);
...
final QuizContent enZhB22ZaiYou = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'He asked the same question again (it happened).', answer: '他**又**问了一遍那个问题。', accepted: ['yòu'], hint: 'tā yòu wèn le yí biàn nà ge wèntí'),
    CourseItem(prompt: 'Let\'s talk about it tomorrow. (future: 再说)', answer: '明天**再**说吧。', accepted: ['zài'], hint: 'míngtiān zài shuō ba'),
    CourseItem(prompt: 'You forgot your keys again!', answer: '你**又**忘了钥匙！', accepted: ['yòu'], hint: 'nǐ yòu wàng le yàoshi'),
    CourseItem(prompt: 'Have another cup (one more, future).', answer: '**再**喝一杯吧。', accepted: ['zài'], hint: 'zài hē yì bēi ba'),
    CourseItem(prompt: 'He\'s sick again (it happened).', answer: '他**又**生病了。', accepted: ['yòu'], hint: 'tā yòu shēngbìng le'),
    CourseItem(prompt: 'Think it over again before deciding. (future: 再想想)', answer: '你**再**想想，然后决定。', accepted: ['zài'], hint: 'nǐ zài xiǎngxiang, ránhòu juédìng'),
    CourseItem(prompt: 'She bought another pair of shoes again yesterday (sigh).', answer: '她昨天**又**买了一双鞋。', accepted: ['yòu'], hint: 'tā zuótiān yòu mǎi le yì shuāng xié'),
    CourseItem(prompt: 'Wash your hands first, then eat. (先…再)', answer: '先洗手，**再**吃饭。', accepted: ['zài'], hint: 'xiān xǐ shǒu, zài chīfàn'),
    CourseItem(prompt: 'It\'s Monday again. (it happened)', answer: '**又**到星期一了。', accepted: ['yòu'], hint: 'yòu dào xīngqīyī le'),
  ],
);
...
final QuizContent enZhB22DouYeHai = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'They are all students.', answer: '他们**都**是学生。', accepted: ['dōu'], hint: 'tāmen dōu shì xuésheng'),
    CourseItem(prompt: 'I also want to go.', answer: '我**也**想去。', accepted: ['yě'], hint: 'wǒ yě xiǎng qù'),
    CourseItem(prompt: 'The kids are still sleeping.', answer: '孩子们**还**在睡觉。', accepted: ['hái'], hint: 'háizimen hái zài shuìjiào'),
    CourseItem(prompt: 'I have tried all of these dishes. (front the dishes!)', answer: '这些菜我**都**吃过。', accepted: ['dōu'], hint: 'zhèxiē cài wǒ dōu chī guo'),
    CourseItem(prompt: 'Neither of us is going. (我们…都不)', answer: '我们**都**不去。', accepted: ['dōu'], hint: 'wǒmen dōu bú qù'),
    CourseItem(prompt: 'My little brother also wants to learn Chinese.', answer: '我弟弟**也**想学中文。', accepted: ['yě'], hint: 'wǒ dìdi yě xiǎng xué Zhōngwén'),
    CourseItem(prompt: 'Is it still raining? (还在…吗)', answer: '**还**在下雨吗？', accepted: ['hái'], hint: 'hái zài xià yǔ ma'),
    CourseItem(prompt: 'He knows everyone here. (front the people: 这里的人)', answer: '这里的人他**都**认识。', accepted: ['dōu'], hint: 'zhèlǐ de rén tā dōu rènshi'),
    CourseItem(prompt: 'Besides tea, I also want some fruit. (in addition: 还)', answer: '除了茶，我**还**要一些水果。', accepted: ['hái'], hint: 'chúle chá, wǒ hái yào yìxiē shuǐguǒ'),
  ],
);
...
final QuizContent enZhB22Pairs = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'She is not only pretty but also very smart. (聪明)', answer: '她**不但**漂亮，**而且**很聪明。', accepted: ['búdàn…érqiě', 'budan erqie'], hint: 'tā búdàn piàoliang, érqiě hěn cōngming'),
    CourseItem(prompt: 'As long as you like it, (then) it\'s fine.', answer: '只要你喜欢**就**好。', accepted: ['jiù'], hint: 'zhǐyào nǐ xǐhuan jiù hǎo'),
    CourseItem(prompt: 'Only by getting up early can you (only then) catch the train.', answer: '只有早起，**才**能赶上火车。', accepted: ['cái'], hint: 'zhǐyǒu zǎo qǐ, cái néng gǎn shàng huǒchē'),
    CourseItem(prompt: 'He not only came, but also brought presents.', answer: '他不但来了，**而且**带来了礼物。', accepted: ['érqiě'], hint: 'tā búdàn lái le, érqiě dài lái le lǐwù'),
    CourseItem(prompt: 'As long as you ask, he\'ll (then) help you.', answer: '只要你开口，他**就**会帮你。', accepted: ['jiù'], hint: 'zhǐyào nǐ kāikǒu, tā jiù huì bāng nǐ'),
    CourseItem(prompt: 'Only on the weekend do I (only then) have time.', answer: '**只有**周末，我才有时间。', accepted: ['zhǐyǒu'], hint: 'zhǐyǒu zhōumò, wǒ cái yǒu shíjiān'),
    CourseItem(prompt: 'This city is not only big but also very beautiful.', answer: '这个城市**不但**大，**而且**很漂亮。', accepted: ['búdàn…érqiě', 'budan erqie'], hint: 'zhè ge chéngshì búdàn dà, érqiě hěn piàoliang'),
    CourseItem(prompt: 'As long as you don\'t give up, there\'s (then) hope. (放弃 / 希望)', answer: '**只要**不放弃，就有希望。', accepted: ['zhǐyào'], hint: 'zhǐyào bú fàngqì, jiù yǒu xīwàng'),
    CourseItem(prompt: 'Only by asking can you (only then) learn. (问 / 学到)', answer: '只有多问，**才**能学到东西。', accepted: ['cái'], hint: 'zhǐyǒu duō wèn, cái néng xué dào dōngxi'),
  ],
);
...
final QuizContent enZhB22Concession = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'Even if I\'m tired, I still want to finish it.', answer: '即使很累，我**也**要做完。', accepted: ['yě'], hint: 'jíshǐ hěn lèi, wǒ yě yào zuò wán'),
    CourseItem(prompt: 'No matter what he says, don\'t (always don\'t) believe it.', answer: '无论他说什么，**都**别相信。', accepted: ['dōu'], hint: 'wúlùn tā shuō shénme, dōu bié xiāngxìn'),
    CourseItem(prompt: 'Even if you don\'t come, we\'ll still start.', answer: '**即使**你不来，我们也开始。', accepted: ['jíshǐ'], hint: 'jíshǐ nǐ bù lái, wǒmen yě kāishǐ'),
    CourseItem(prompt: 'No matter how expensive, he always buys it.', answer: '**无论**多贵，他都买。', accepted: ['wúlùn'], hint: 'wúlùn duō guì, tā dōu mǎi'),
    CourseItem(prompt: 'No matter when you come, I\'ll always be at home.', answer: '无论你什么时候来，我**都**在家。', accepted: ['dōu'], hint: 'wúlùn nǐ shénme shíhou lái, wǒ dōu zài jiā'),
    CourseItem(prompt: 'Even if everyone opposes it, I\'ll still do it. (反对)', answer: '即使大家都反对，我**也**要做。', accepted: ['yě'], hint: 'jíshǐ dàjiā dōu fǎnduì, wǒ yě yào zuò'),
    CourseItem(prompt: 'No matter how the weather is, we always run. (天气怎么样)', answer: '**无论**天气怎么样，我们都跑步。', accepted: ['wúlùn'], hint: 'wúlùn tiānqì zěnmeyàng, wǒmen dōu pǎobù'),
    CourseItem(prompt: 'Even if I fail, I\'ll still try once. (失败 / 试)', answer: '即使失败，我**也**要试一次。', accepted: ['yě'], hint: 'jíshǐ shībài, wǒ yě yào shì yí cì'),
    CourseItem(prompt: 'No matter whether it\'s expensive or cheap (A不A), he always wants to look.', answer: '无论贵不贵，他**都**想看看。', accepted: ['dōu'], hint: 'wúlùn guì bu guì, tā dōu xiǎng kànkan'),
    CourseItem(prompt: 'Even if you\'ve heard it, still listen once more.', answer: '**即使**你听过，也再听一遍。', accepted: ['jíshǐ'], hint: 'jíshǐ nǐ tīng guo, yě zài tīng yí biàn'),
  ],
);
...
final QuizContent enZhB22Feelings = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'nervous', answer: '紧张', accepted: ['jǐnzhāng'], hint: 'jǐnzhāng'),
    CourseItem(prompt: 'disappointed', answer: '失望', accepted: ['shīwàng'], hint: 'shīwàng'),
    CourseItem(prompt: 'She is interested in music.', answer: '她**对**音乐感兴趣。', accepted: ['duì'], hint: 'tā duì yīnyuè gǎn xìngqù'),
    CourseItem(prompt: 'happy / joyful (opens the heart)', answer: '开心', accepted: ['kāixīn'], hint: 'kāixīn'),
    CourseItem(prompt: 'angry (generates air)', answer: '生气', accepted: ['shēngqì'], hint: 'shēngqì'),
    CourseItem(prompt: 'I\'m worried about his health.', answer: '我很**担心**他的身体。', accepted: ['dānxīn'], hint: 'wǒ hěn dānxīn tā de shēntǐ'),
    CourseItem(prompt: 'satisfied (full-意)', answer: '满意', accepted: ['mǎnyì'], hint: 'mǎnyì'),
    CourseItem(prompt: 'Don\'t worry — I\'ll be careful. (放心)', answer: '你**放心**，我会小心的。', accepted: ['fàngxīn'], hint: 'nǐ fàngxīn, wǒ huì xiǎoxīn de'),
  ],
);
...
final QuizContent enZhB22DictAttitude = enZhDict(
  ...
  items: const [
    ...
    CourseItem(prompt: 'I understood after listening once.', answer: '我听了一遍就懂了。'),
    CourseItem(prompt: 'No matter how busy, you must eat.', answer: '无论多忙，都要吃饭。'),
    CourseItem(prompt: 'She is wearing a red coat.', answer: '她穿着红大衣。'),
    CourseItem(prompt: 'We are all going.', answer: '我们都去。'),
    CourseItem(prompt: 'He is still working.', answer: '他还在工作。'),
    CourseItem(prompt: 'You forgot your keys again!', answer: '你又忘了钥匙！'),
    CourseItem(prompt: 'As long as you practise, you\'ll improve.', answer: '只要你练习，就会进步。'),
    CourseItem(prompt: 'A photo hangs on the wall.', answer: '墙上挂着一张照片。'),
    CourseItem(prompt: 'Even if it rains, I will still go.', answer: '即使下雨，我也去。'),
  ],
);
