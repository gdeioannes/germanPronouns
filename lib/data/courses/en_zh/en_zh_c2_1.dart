...
final QuizContent enZhC21Chengyu1 = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'in high spirits (interest bubbling up)', answer: '兴致勃勃', accepted: ['xìngzhì bóbó', 'xing zhi bo bo'], hint: 'xìngzhì bóbó'),
    CourseItem(prompt: 'beyond expectation (out of what was expected)', answer: '出乎意料', accepted: ['chū hū yì liào'], hint: 'chū hū yì liào'),
    CourseItem(prompt: 'days feel like years (passing a day like a year)', answer: '度日如年', accepted: ['dù rì rú nián'], hint: 'dù rì rú nián'),
    CourseItem(prompt: 'After the mountain hike we were utterly exhausted.', answer: '爬完山，我们**筋疲力尽**。', accepted: ['jīn pí lì jìn'], hint: 'pá wán shān, wǒmen jīn pí lì jìn'),
    CourseItem(prompt: 'The result was beyond everyone\'s expectation.', answer: '结果**出乎意料**。', accepted: ['chū hū yì liào'], hint: 'jiéguǒ chū hū yì liào'),
    CourseItem(prompt: 'ten thousand purples and reds — a riot of spring color', answer: '万紫千红', accepted: ['wàn zǐ qiān hóng'], hint: 'wàn zǐ qiān hóng'),
    CourseItem(prompt: 'to look forward to something day and night (朝思暮想)', answer: '朝思暮想', accepted: ['zhāo sī mù xiǎng'], hint: 'zhāo sī mù xiǎng'),
    CourseItem(prompt: 'Waiting for the exam results, every day felt like a year.', answer: '等成绩的时候，真是**度日如年**。', accepted: ['dù rì rú nián'], hint: 'děng chéngjì de shíhou, zhēn shì dù rì rú nián'),
    CourseItem(prompt: 'They chatted and laughed merrily all evening. (use the 成语!)', answer: '他们整个晚上**谈笑风生**。', accepted: ['tán xiào fēng shēng'], hint: 'tāmen zhěnggè wǎnshang tán xiào fēng shēng'),
  ],
);
...
final QuizContent enZhC21Chengyu2 = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'largely identical with minor differences', answer: '大同小异', accepted: ['dà tóng xiǎo yì'], hint: 'dà tóng xiǎo yì'),
    CourseItem(prompt: 'the flaw doesn\'t obscure the jade (praise despite a defect)', answer: '瑕不掩瑜', accepted: ['xiá bù yǎn yú'], hint: 'xiá bù yǎn yú'),
    CourseItem(prompt: 'to kill two birds with one stone (one action, two gains)', answer: '一举两得', accepted: ['yì jǔ liǎng dé'], hint: 'yì jǔ liǎng dé'),
    CourseItem(prompt: 'In the final analysis, this is an attitude problem.', answer: '**归根结底**，这是态度问题。', accepted: ['guī gēn jié dǐ'], hint: 'guī gēn jié dǐ, zhè shì tàidù wèntí'),
    CourseItem(prompt: 'This plan kills two birds with one stone.', answer: '这个方案**一举两得**。', accepted: ['yì jǔ liǎng dé'], hint: 'zhè ge fāng\'àn yì jǔ liǎng dé'),
    CourseItem(prompt: 'The gap between the two cities is night and day. (use the 成语!)', answer: '这两个城市有**天壤之别**。', accepted: ['tiān rǎng zhī bié'], hint: 'zhè liǎng ge chéngshì yǒu tiān rǎng zhī bié'),
    CourseItem(prompt: 'self-evident, goes without saying (不言而喻)', answer: '不言而喻', accepted: ['bù yán ér yù'], hint: 'bù yán ér yù'),
    CourseItem(prompt: 'to treat the symptom, not the root cause (治标不治本)', answer: '治标不治本', accepted: ['zhì biāo bú zhì běn'], hint: 'zhì biāo bú zhì běn'),
    CourseItem(prompt: 'Blaming the tool is putting the cart before the horse.', answer: '怪工具就是**本末倒置**。', accepted: ['běn mò dào zhì'], hint: 'guài gōngjù jiù shì běn mò dào zhì'),
  ],
);
...
final QuizContent enZhC21Guanyongyu = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'to pour cold water on (discourage)', answer: '泼冷水', accepted: ['pō lěngshuǐ'], hint: 'pō lěngshuǐ'),
    CourseItem(prompt: 'to have an iron rice bowl (secure job)', answer: '铁饭碗', accepted: ['tiě fànwǎn'], hint: 'tiě fànwǎn'),
    CourseItem(prompt: '"Failure is the mother of success."', answer: '失败是成功之母', accepted: ['shībài shì chénggōng zhī mǔ'], hint: 'shībài shì chénggōng zhī mǔ'),
    CourseItem(prompt: 'Don\'t make him the scapegoat for this.', answer: '别让他**背黑锅**。', accepted: ['bēi hēiguō'], hint: 'bié ràng tā bēi hēiguō'),
    CourseItem(prompt: 'to cut corners / skimp on the work (偷工减料)', answer: '偷工减料', accepted: ['tōu gōng jiǎn liào'], hint: 'tōu gōng jiǎn liào'),
    CourseItem(prompt: 'to show off (露一手)', answer: '露一手', accepted: ['lòu yì shǒu'], hint: 'lòu yì shǒu'),
    CourseItem(prompt: '"A tall tree catches the wind." (fame attracts trouble)', answer: '树大招风', accepted: ['shù dà zhāo fēng'], hint: 'shù dà zhāo fēng'),
    CourseItem(prompt: 'Stop pouring cold water on my plans!', answer: '别再给我的计划**泼冷水**了！', accepted: ['pō lěngshuǐ'], hint: 'bié zài gěi wǒ de jìhuà pō lěngshuǐ le'),
    CourseItem(prompt: 'He\'s only good at flattering the boss.', answer: '他只会给老板**拍马屁**。', accepted: ['pāi mǎpì'], hint: 'tā zhǐ huì gěi lǎobǎn pāi mǎpì'),
  ],
);
...
final QuizContent enZhC21Connotation = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'She is self-confident (+).', answer: '她很**自信**。', accepted: ['zìxìn'], hint: 'tā hěn zìxìn'),
    CourseItem(prompt: 'He is conceited (−, over-confident).', answer: '他太**自负**了。', accepted: ['zìfù'], hint: 'tā tài zìfù le'),
    CourseItem(prompt: 'The plan is flexible (+, 灵活).', answer: '这个计划很**灵活**。', accepted: ['línghuó'], hint: 'zhè ge jìhuà hěn línghuó'),
    CourseItem(prompt: 'He is sly (−, 狡猾).', answer: '他很**狡猾**。', accepted: ['jiǎohuá'], hint: 'tā hěn jiǎohuá'),
    CourseItem(prompt: 'She is clever (+, 机智) in negotiations.', answer: '她在谈判中很**机智**。', accepted: ['jīzhì'], hint: 'tā zài tánpàn zhōng hěn jīzhì'),
    CourseItem(prompt: 'He is stubborn (−, 固执).', answer: '他太**固执**了。', accepted: ['gùzhí'], hint: 'tā tài gùzhí le'),
    CourseItem(prompt: 'She sticks to her principles (+, 坚定).', answer: '她的立场很**坚定**。', accepted: ['jiāndìng'], hint: 'tā de lìchǎng hěn jiāndìng'),
    CourseItem(prompt: 'The report\'s results (neutral, 结果) came out today.', answer: '报告的**结果**今天出来了。', accepted: ['jiéguǒ'], hint: 'bàogào de jiéguǒ jīntiān chūlái le'),
    CourseItem(prompt: 'He is frugal in daily life but generous to friends. (+, 节俭)', answer: '他生活**节俭**，对朋友却很大方。', accepted: ['jiéjiǎn'], hint: 'tā shēnghuó jiéjiǎn, duì péngyou què hěn dàfang'),
  ],
);
...
final QuizContent enZhC21Marked = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'Even the teacher couldn\'t answer this question.', answer: '**连**老师**都**回答不了这个问题。', accepted: ['lián…dōu', 'lian dou'], hint: 'lián lǎoshī dōu huídá bùliǎo zhè ge wèntí'),
    CourseItem(prompt: 'However tired, she still runs every day.', answer: '**再**累她**也**每天跑步。', accepted: ['zài…yě', 'zai ye'], hint: 'zài lèi tā yě měitiān pǎobù'),
    CourseItem(prompt: 'Today I simply must finish this task.', answer: '今天我**非**做完这个任务**不可**。', accepted: ['fēi…bùkě', 'fei buke'], hint: 'jīntiān wǒ fēi zuò wán zhè ge rènwù bùkě'),
    CourseItem(prompt: 'He didn\'t even drink one mouthful of water.', answer: '他**连**一口水**都**没喝。', accepted: ['lián…dōu'], hint: 'tā lián yì kǒu shuǐ dōu méi hē'),
    CourseItem(prompt: 'You simply must see this film.', answer: '这部电影你**非**看**不可**。', accepted: ['fēi…bùkě'], hint: 'zhè bù diànyǐng nǐ fēi kàn bùkě'),
    CourseItem(prompt: 'Even on Sunday he works.', answer: '**连**星期天他**都**工作。', accepted: ['lián…dōu', 'lian dou'], hint: 'lián xīngqītiān tā dōu gōngzuò'),
    CourseItem(prompt: 'However much money you give, he won\'t sell.', answer: '你**再**给多少钱，他**也**不卖。', accepted: ['zài…yě', 'zai ye'], hint: 'nǐ zài gěi duōshao qián, tā yě bú mài'),
    CourseItem(prompt: 'This matter simply must be made clear today.', answer: '这件事今天**非**说清楚**不可**。', accepted: ['fēi…bùkě', 'fei buke'], hint: 'zhè jiàn shì jīntiān fēi shuō qīngchu bùkě'),
    CourseItem(prompt: 'She didn\'t even take a day of rest.', answer: '她**连**一天**都**没休息。', accepted: ['lián…dōu'], hint: 'tā lián yì tiān dōu méi xiūxi'),
    CourseItem(prompt: 'However hard it is, we must keep going.', answer: '**再**难我们**也**要坚持下去。', accepted: ['zài…yě', 'zai ye'], hint: 'zài nán wǒmen yě yào jiānchí xiàqù'),
  ],
);
...
final QuizContent enZhC21Xiehouyu = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'A blind man lights a lamp — …a wasted effort. (白费蜡)', answer: '瞎子点灯——**白费蜡**', accepted: ['bái fèi là'], hint: 'xiāzi diǎn dēng — bái fèi là'),
    CourseItem(prompt: 'Sun Wukong\'s face — …changes at will. (说变就变)', answer: '孙悟空的脸——**说变就变**', accepted: ['shuō biàn jiù biàn'], hint: 'Sūn Wùkōng de liǎn — shuō biàn jiù biàn'),
    CourseItem(prompt: 'Dumplings in a teapot — …can\'t pour them out. (有货倒不出)', answer: '茶壶里煮饺子——**有货倒不出**', accepted: ['yǒu huò dào bu chū'], hint: 'cháhú li zhǔ jiǎozi — yǒu huò dào bu chū'),
    CourseItem(prompt: 'Sesame blossoms on the stalk — …rising ever higher. (节节高)', answer: '芝麻开花——**节节高**', accepted: ['jié jié gāo'], hint: 'zhīma kāihuā — jié jié gāo'),
    CourseItem(prompt: 'His new job is like sesame blossoms — rising step by step.', answer: '他的新工作像芝麻开花——**节节高**。', accepted: ['jié jié gāo'], hint: 'tā de xīn gōngzuò xiàng zhīma kāihuā — jié jié gāo'),
    CourseItem(prompt: 'A rat crossing the street — …everyone shouts "hit it!". (人人喊打)', answer: '老鼠过街——**人人喊打**', accepted: ['rén rén hǎn dǎ'], hint: 'lǎoshǔ guò jiē — rén rén hǎn dǎ'),
    CourseItem(prompt: 'Sima Zhao\'s intent — …obvious to every passer-by. (路人皆知)', answer: '司马昭之心——**路人皆知**', accepted: ['lù rén jiē zhī'], hint: 'Sīmǎ Zhāo zhī xīn — lù rén jiē zhī'),
    CourseItem(prompt: 'A dog trying to catch mice — …meddling in others\' business. (多管闲事)', answer: '狗拿耗子——**多管闲事**', accepted: ['duō guǎn xián shì'], hint: 'gǒu ná hàozi — duō guǎn xián shì'),
    CourseItem(prompt: 'Lighting a lamp in broad daylight — …a waste. (白搭)', answer: '大白天点灯——**白搭**', accepted: ['bái dā'], hint: 'dà báitiān diǎn dēng — bái dā'),
    CourseItem(prompt: 'He knows a lot but can\'t express it — dumplings in a teapot.', answer: '他懂得很多，可是茶壶里煮饺子——**有货倒不出**。', accepted: ['yǒu huò dào bu chū'], hint: 'tā dǒng de hěn duō, kěshì cháhú li zhǔ jiǎozi — yǒu huò dào bu chū'),
  ],
);
...
final QuizContent enZhC21AspectNuance = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'I have seen this film (experience credit).', answer: '这部电影我看**过**。', accepted: ['guo', 'guò'], hint: 'zhè bù diànyǐng wǒ kàn guo'),
    CourseItem(prompt: 'Leave the door open (keep the state)! (开着)', answer: '门开**着**吧，别关。', accepted: ['zhe'], hint: 'mén kāi zhe ba, bié guān'),
    CourseItem(prompt: 'I have been learning Chinese for five years (and counting).', answer: '我学中文学了五年**了**。', accepted: ['le'], hint: 'wǒ xué Zhōngwén xué le wǔ nián le'),
    CourseItem(prompt: 'He once worked in Shanghai (experience, no longer).', answer: '他在上海工作**过**。', accepted: ['guo', 'guò'], hint: 'tā zài Shànghǎi gōngzuò guo'),
    CourseItem(prompt: 'Keep the window open while you cook. (state in force)', answer: '做饭的时候让窗户开**着**。', accepted: ['zhe'], hint: 'zuòfàn de shíhou ràng chuānghu kāi zhe'),
    CourseItem(prompt: 'We have known each other for twenty years (and counting).', answer: '我们认识二十年**了**。', accepted: ['le'], hint: 'wǒmen rènshi èrshí nián le'),
    CourseItem(prompt: 'Have you ever thought about this question? (experience)', answer: '这个问题你想**过**吗？', accepted: ['guo', 'guò'], hint: 'zhè ge wèntí nǐ xiǎng guo ma'),
    CourseItem(prompt: 'Remember it well — don\'t forget! (记着)', answer: '记**着**，别忘了！', accepted: ['zhe'], hint: 'jì zhe, bié wàng le'),
    CourseItem(prompt: 'By the time we got there, the tickets were (already) sold out.', answer: '我们到的时候，票已经卖完**了**。', accepted: ['le'], hint: 'wǒmen dào de shíhou, piào yǐjīng mài wán le'),
  ],
);
...
final QuizContent enZhC21DictNuance = enZhDict(
  ...
  items: const [
    ...
    CourseItem(prompt: 'He didn\'t even say goodbye.', answer: '他连再见都没说。'),
    CourseItem(prompt: 'Don\'t pour cold water on him.', answer: '别给他泼冷水。'),
    CourseItem(prompt: 'The two plans are largely the same.', answer: '这两个方案大同小异。'),
    CourseItem(prompt: 'Hold it — don\'t let go!', answer: '拿着，别松手！'),
    CourseItem(prompt: 'His decision was very decisive.', answer: '他的决定很果断。'),
    CourseItem(prompt: 'He pulled an all-nighter to finish the report.', answer: '他开夜车把报告写完了。'),
    CourseItem(prompt: 'The result was beyond expectation.', answer: '结果出乎意料。'),
    CourseItem(prompt: 'You must bear the consequences yourself.', answer: '你要自己承担后果。'),
    CourseItem(prompt: 'This dish? Piece of cake for her.', answer: '这个菜对她来说是小菜一碟。'),
  ],
);
...
final QuizContent enZhC21Precision = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'to play an important role (发挥作用)', answer: '**发挥**重要作用', accepted: ['fāhuī'], hint: 'fāhuī zhòngyào zuòyòng'),
    CourseItem(prompt: 'to carry forward the spirit (of a team)', answer: '**发扬**团队精神', accepted: ['fāyáng'], hint: 'fāyáng tuánduì jīngshén'),
    CourseItem(prompt: 'to spend an unforgettable evening', answer: '**度过**了一个难忘的夜晚', accepted: ['dùguò'], hint: 'dùguò le yí ge nánwàng de yèwǎn'),
    CourseItem(prompt: 'to help the company weather the difficulty', answer: '帮公司**渡过**困难', accepted: ['dùguò'], hint: 'bāng gōngsī dùguò kùnnan'),
    CourseItem(prompt: 'to bring imagination into play (发挥想象力)', answer: '**发挥**想象力', accepted: ['fāhuī'], hint: 'fāhuī xiǎngxiànglì'),
    CourseItem(prompt: 'to carry forward the spirit of hard work', answer: '**发扬**艰苦奋斗的精神', accepted: ['fāyáng'], hint: 'fāyáng jiānkǔ fèndòu de jīngshén'),
    CourseItem(prompt: 'to spend the Spring Festival with family', answer: '和家人一起**度过**春节', accepted: ['dùguò'], hint: 'hé jiārén yìqǐ dùguò Chūnjié'),
    CourseItem(prompt: 'to raise the level of service (提高水平)', answer: '**提高**服务水平', accepted: ['tígāo'], hint: 'tígāo fúwù shuǐpíng'),
    CourseItem(prompt: 'to perfect the management system (完善)', answer: '**完善**管理制度', accepted: ['wánshàn'], hint: 'wánshàn guǎnlǐ zhìdù'),
  ],
);
