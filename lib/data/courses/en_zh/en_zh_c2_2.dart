...
final QuizContent enZhC22Wenyan = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'The so-called expert had never been to the site.', answer: '**所谓**的专家，其实从没去过现场。', accepted: ['suǒwèi'], hint: 'suǒwèi de zhuānjiā, qíshí cóng méi qù guo xiànchǎng'),
    CourseItem(prompt: 'Everyone present was deeply moved. (written all: 皆)', answer: '在场的人**皆**深受感动。', accepted: ['jiē'], hint: 'zàichǎng de rén jiē shēn shòu gǎndòng'),
    CourseItem(prompt: 'This is precisely the meaning of life. (乃)', answer: '这**乃**是生活的意义。', accepted: ['nǎi'], hint: 'zhè nǎi shì shēnghuó de yìyì'),
    CourseItem(prompt: 'It\'s only a suggestion, nothing more.', answer: '这只是一个建议**而已**。', accepted: ['éryǐ'], hint: 'zhè zhǐshì yí ge jiànyì éryǐ'),
    CourseItem(prompt: 'So-called freedom is not doing whatever one wants.', answer: '**所谓**自由，并不是想做什么就做什么。', accepted: ['suǒwèi'], hint: 'suǒwèi zìyóu, bìng bú shì xiǎng zuò shénme jiù zuò shénme'),
    CourseItem(prompt: 'All roads lead to Rome — every method works. (written all: 皆)', answer: '条条大路**皆**通罗马。', accepted: ['jiē'], hint: 'tiáo tiáo dàlù jiē tōng Luómǎ'),
    CourseItem(prompt: 'This is precisely the difference between the two. (乃)', answer: '这**乃**是两者的区别所在。', accepted: ['nǎi'], hint: 'zhè nǎi shì liǎngzhě de qūbié suǒzài'),
    CourseItem(prompt: 'It was a misunderstanding, nothing more.', answer: '这不过是个误会**而已**。', accepted: ['éryǐ'], hint: 'zhè búguò shì ge wùhuì éryǐ'),
    CourseItem(prompt: 'The so-called tradition is barely thirty years old.', answer: '**所谓**的传统，其实才三十年。', accepted: ['suǒwèi'], hint: 'suǒwèi de chuántǒng, qíshí cái sānshí nián'),
    CourseItem(prompt: 'All present agreed without exception. (written all: 皆)', answer: '在场者**皆**表示同意。', accepted: ['jiē'], hint: 'zàichǎng zhě jiē biǎoshì tóngyì'),
  ],
);
...
final QuizContent enZhC22Cohesion = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'In other words, we still need more evidence.', answer: '**换言之**，我们还需要更多证据。', accepted: ['huànyánzhī'], hint: 'huànyánzhī, wǒmen hái xūyào gèng duō zhèngjù'),
    CourseItem(prompt: 'To sum up the above, the plan is feasible.', answer: '**综上所述**，该方案是可行的。', accepted: ['zōng shàng suǒ shù'], hint: 'zōng shàng suǒ shù, gāi fāng\'àn shì kěxíng de'),
    CourseItem(prompt: 'The former is the cause; the latter, the result.', answer: '**前者**是原因，**后者**是结果。', accepted: ['qiánzhě…hòuzhě'], hint: 'qiánzhě shì yuányīn, hòuzhě shì jiéguǒ'),
    CourseItem(prompt: 'As stated above, the two are closely related.', answer: '**如上所述**，两者关系密切。', accepted: ['rú shàng suǒ shù'], hint: 'rú shàng suǒ shù, liǎngzhě guānxi mìqiè'),
    CourseItem(prompt: 'This question has been answered in the text above. (上文)', answer: '这个问题**上文**已经回答了。', accepted: ['shàngwén'], hint: 'zhè ge wèntí shàngwén yǐjīng huídá le'),
    CourseItem(prompt: 'In other words, the decision was made long ago.', answer: '**换言之**，决定早就做出了。', accepted: ['huànyánzhī', 'huan yan zhi'], hint: 'huànyánzhī, juédìng zǎo jiù zuòchū le'),
    CourseItem(prompt: 'To sum up the above, we recommend postponing the project.', answer: '**综上所述**，我们建议推迟该项目。', accepted: ['zōng shàng suǒ shù'], hint: 'zōng shàng suǒ shù, wǒmen jiànyì tuīchí gāi xiàngmù'),
    CourseItem(prompt: 'The former is easier said; the latter, easier done.', answer: '**前者**易说，**后者**易做。', accepted: ['qiánzhě…hòuzhě', 'qianzhe houzhe'], hint: 'qiánzhě yì shuō, hòuzhě yì zuò'),
    CourseItem(prompt: 'As stated above, cost is not the main obstacle.', answer: '**如上所述**，成本并不是主要障碍。', accepted: ['rú shàng suǒ shù'], hint: 'rú shàng suǒ shù, chéngběn bìng bú shì zhǔyào zhàng\'ài'),
    CourseItem(prompt: 'The details will be explained in the text below. (下文)', answer: '细节将在**下文**说明。', accepted: ['xiàwén'], hint: 'xìjié jiāng zài xiàwén shuōmíng'),
  ],
);
...
final QuizContent enZhC22Weighing = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'Rather than envy others, better to improve yourself.', answer: '**与其**羡慕别人，不如提高自己。', accepted: ['yǔqí'], hint: 'yǔqí xiànmù biérén, bùrú tígāo zìjǐ'),
    CourseItem(prompt: 'I\'d sooner walk than take that crowded bus.', answer: '我**宁可**走路，**也不**坐那辆挤车。', accepted: ['nìngkě…yěbù', 'ningke yebu'], hint: 'wǒ nìngkě zǒulù, yě bú zuò nà liàng jǐ chē'),
    CourseItem(prompt: 'Rather than regret later, better to prepare now.', answer: '与其以后后悔，**不如**现在准备。', accepted: ['bùrú'], hint: 'yǔqí yǐhòu hòuhuǐ, bùrú xiànzài zhǔnbèi'),
    CourseItem(prompt: 'She would sooner tell the truth than lie. (宁可…也不)', answer: '她**宁可**说实话，**也不**说谎。', accepted: ['nìngkě'], hint: 'tā nìngkě shuō shíhuà, yě bù shuōhuǎng'),
    CourseItem(prompt: 'Rather than blame the environment, better to change your method.', answer: '**与其**抱怨环境，不如改变方法。', accepted: ['yǔqí'], hint: 'yǔqí bàoyuàn huánjìng, bùrú gǎibiàn fāngfǎ'),
    CourseItem(prompt: 'Rather than memorize rules, better to read more.', answer: '**与其**死记规则，不如多阅读。', accepted: ['yǔqí'], hint: 'yǔqí sǐjì guīzé, bùrú duō yuèdú'),
    CourseItem(prompt: 'I\'d sooner say nothing than lie. (宁可…也不)', answer: '我**宁可**不说，**也不**说谎。', accepted: ['nìngkě…yěbù', 'ningke yebu'], hint: 'wǒ nìngkě bù shuō, yě bù shuōhuǎng'),
    CourseItem(prompt: 'Rather than buy cheap and often, better to buy good once.', answer: '与其常买便宜的，**不如**买一次好的。', accepted: ['bùrú'], hint: 'yǔqí cháng mǎi piányi de, bùrú mǎi yí cì hǎo de'),
    CourseItem(prompt: 'He\'d sooner lose money than lose a friend. (宁可…也不)', answer: '他**宁可**赔钱，**也不**失去朋友。', accepted: ['nìngkě'], hint: 'tā nìngkě péi qián, yě bù shīqù péngyou'),
    CourseItem(prompt: 'Rather than guess, better to ask directly.', answer: '与其猜来猜去，**不如**直接问。', accepted: ['bùrú'], hint: 'yǔqí cāi lái cāi qù, bùrú zhíjiē wèn'),
  ],
);
...
final QuizContent enZhC22Allusion = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'to wait passively for windfalls (guard the stump, wait for the hare)', answer: '守株待兔', accepted: ['shǒu zhū dài tù'], hint: 'shǒu zhū dài tù'),
    CourseItem(prompt: 'to deceive oneself (cover one\'s ears to steal the bell)', answer: '掩耳盗铃', accepted: ['yǎn ěr dào líng'], hint: 'yǎn ěr dào líng'),
    CourseItem(prompt: 'to spur growth by force and ruin it (pull the seedlings to help them grow)', answer: '拔苗助长', accepted: ['bá miáo zhù zhǎng'], hint: 'bá miáo zhù zhǎng'),
    CourseItem(prompt: 'Cramming a year of study into a week is pulling up the seedlings.', answer: '一周学完一年的课，就是**拔苗助长**。', accepted: ['bá miáo zhù zhǎng'], hint: 'yì zhōu xué wán yì nián de kè, jiù shì bá miáo zhù zhǎng'),
    CourseItem(prompt: 'Keeping the old strategy in a new market is carving the boat to find the sword.', answer: '新市场用老办法，就是**刻舟求剑**。', accepted: ['kè zhōu qiú jiàn'], hint: 'xīn shìchǎng yòng lǎo bànfǎ, jiù shì kè zhōu qiú jiàn'),
    CourseItem(prompt: 'He says he loves challenges, but avoids every one — Lord Ye and his dragons.', answer: '他说爱挑战，遇到就躲，真是**叶公好龙**。', accepted: ['Yè gōng hào lóng'], hint: 'tā shuō ài tiǎozhàn, yùdào jiù duǒ, zhēn shì Yè gōng hào lóng'),
    CourseItem(prompt: 'Waiting for customers without marketing is guarding the stump.', answer: '不做宣传等客人，就是**守株待兔**。', accepted: ['shǒu zhū dài tù'], hint: 'bú zuò xuānchuán děng kèrén, jiù shì shǒu zhū dài tù'),
    CourseItem(prompt: 'Deleting the bad reviews doesn\'t fix the product — that\'s covering your ears to steal the bell.', answer: '删差评解决不了问题，那是**掩耳盗铃**。', accepted: ['yǎn ěr dào líng'], hint: 'shān chàpíng jiějué bùliǎo wèntí, nà shì yǎn ěr dào líng'),
    CourseItem(prompt: 'to add flowers to brocade — gild what is already splendid (锦上添花)', answer: '锦上添花', accepted: ['jǐn shàng tiān huā'], hint: 'jǐn shàng tiān huā'),
  ],
);
...
final QuizContent enZhC22Natural = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: 'Stiff: 我对此感到非常高兴。 Natural: drop the scaffolding.', answer: '我**特别高兴**。', accepted: ['tèbié gāoxìng'], hint: 'wǒ tèbié gāoxìng'),
    CourseItem(prompt: 'Stiff: 如果你有任何问题，请联系我。 Natural: 有问题 is enough.', answer: '**有问题**随时找我。', accepted: ['yǒu wèntí'], hint: 'yǒu wèntí suíshí zhǎo wǒ'),
    CourseItem(prompt: 'Stiff: 这本书被很多人阅读。 Natural: topic first, no passive.', answer: '这本书**很多人看**。', accepted: ['hěn duō rén kàn'], hint: 'zhè běn shū hěn duō rén kàn'),
    CourseItem(prompt: 'Stiff: 我想要表达我的感谢。 Natural: one verb does it.', answer: '**谢谢**大家。', accepted: ['xièxie'], hint: 'xièxie dàjiā'),
    CourseItem(prompt: 'Stiff: 它是重要的，我们保持冷静。 Natural: 重要的是 + verb.', answer: '**重要的是**保持冷静。', accepted: ['zhòngyào de shì'], hint: 'zhòngyào de shì bǎochí lěngjìng'),
    CourseItem(prompt: 'Stiff: 我不能同意你更多了。 Natural: total agreement without the calque.', answer: '我**完全同意**。', accepted: ['wánquán tóngyì'], hint: 'wǒ wánquán tóngyì'),
    CourseItem(prompt: 'Stiff: 让我们开始我们的会议。 Natural: drop both 我们.', answer: '**开会吧**。', accepted: ['kāihuì ba'], hint: 'kāihuì ba'),
    CourseItem(prompt: 'Stiff: 他做出了一个决定。 Natural: verb it directly.', answer: '他**决定**了。', accepted: ['juédìng'], hint: 'tā juédìng le'),
    CourseItem(prompt: 'Stiff: 天气是好的，所以我们出去了。 Natural: no copula, no 所以 needed.', answer: '天气好，我们**就出去了**。', accepted: ['jiù chūqù le'], hint: 'tiānqì hǎo, wǒmen jiù chūqù le'),
  ],
);
...
final QuizContent enZhC22Irony = enZhFill(
  ...
  items: const [
    ...
    CourseItem(prompt: '"What a coincidence." (ironic 真巧 after obvious planning)', answer: '可**真巧**啊。', accepted: ['zhēn qiǎo'], hint: 'kě zhēn qiǎo a'),
    CourseItem(prompt: 'And you still have the nerve to ask?!', answer: '你还**好意思**问？', accepted: ['hǎoyìsi'], hint: 'nǐ hái hǎoyìsi wèn'),
    CourseItem(prompt: '"Great, just great." (mock praise 好得很)', answer: '**好得很**，这下全完了。', accepted: ['hǎo de hěn'], hint: 'hǎo de hěn, zhè xià quán wán le'),
    CourseItem(prompt: 'Oh, so YOU\'re the busy one. (您 used ironically)', answer: '**您**可真是大忙人。', accepted: ['nín'], hint: 'nín kě zhēn shì dà mángrén'),
    CourseItem(prompt: 'That\'s SOME "help" you gave. (所谓 scare quotes)', answer: '这就是你**所谓**的"帮忙"？', accepted: ['suǒwèi'], hint: 'zhè jiù shì nǐ suǒwèi de "bāngmáng"'),
    CourseItem(prompt: '"You\'re SO early." (ironic 真早 to the latecomer)', answer: '你来得可**真早**啊。', accepted: ['zhēn zǎo'], hint: 'nǐ lái de kě zhēn zǎo a'),
    CourseItem(prompt: 'Well, EXCUSE me. (mock apology 对不起您了)', answer: '那真是**对不起您**了。', accepted: ['duìbuqǐ nín'], hint: 'nà zhēn shì duìbuqǐ nín le'),
    CourseItem(prompt: 'Great weather — it\'s pouring. (ironic 真不错)', answer: '天气可**真不错**，下这么大雨。', accepted: ['zhēn búcuò'], hint: 'tiānqì kě zhēn búcuò, xià zhème dà yǔ'),
    CourseItem(prompt: 'And you have the nerve to be angry?!', answer: '你还**好意思**生气？', accepted: ['hǎoyìsi'], hint: 'nǐ hái hǎoyìsi shēngqì'),
    CourseItem(prompt: '"How thoughtful of you." (ironic 想得真周到)', answer: '您可**想得真周到**。', accepted: ['xiǎng de zhēn zhōudào'], hint: 'nín kě xiǎng de zhēn zhōudào'),
  ],
);
...
final QuizContent enZhC22DictEditorial = enZhDict(
  ...
  items: const [
    ...
    CourseItem(prompt: 'In other words, quality matters more than quantity.', answer: '换言之，质量比数量更重要。'),
    CourseItem(prompt: 'Rather than complain, better to act.', answer: '与其抱怨，不如行动。'),
    CourseItem(prompt: 'The former stresses efficiency; the latter, fairness.', answer: '前者强调效率，后者强调公平。'),
    CourseItem(prompt: 'Losing that job was perhaps a blessing in disguise.', answer: '丢了那份工作，也许是塞翁失马。'),
    CourseItem(prompt: 'Everyone present was deeply moved.', answer: '在场的人皆深受感动。'),
    CourseItem(prompt: 'As stated above, the data supports this conclusion.', answer: '如上所述，数据支持这一结论。'),
    CourseItem(prompt: 'I\'d sooner be a bit tired than give up.', answer: '我宁可累一点，也不放弃。'),
    CourseItem(prompt: 'The last paragraph is pure legs-on-a-snake.', answer: '最后一段完全是画蛇添足。'),
    CourseItem(prompt: 'It was a misunderstanding, nothing more.', answer: '这不过是个误会而已。'),
    CourseItem(prompt: 'To sum up the above, the plan is feasible.', answer: '综上所述，该方案是可行的。'),
  ],
);
