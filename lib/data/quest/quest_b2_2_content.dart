...
final QuizContent questB22UmweltContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Wir trennen den ____ zu Hause. (rubbish)', 'Müll',
        'We separate the rubbish at home.', 'rubbish',
        accepted: ['Muell']),
    qsi('Glas und Papier kann man ____. (recycle)', 'recyceln',
        'Glass and paper can be recycled.', 'recycle'),
    qsi('Solarenergie ist eine ____ Energie. (renewable)', 'erneuerbare',
        'Solar power is a renewable energy.', 'renewable'),
    qsi('Die ____ der Meere ist ein großes Problem. (pollution)',
        'Verschmutzung', 'The pollution of the oceans is a big problem.',
        'pollution'),
    qsi('Autos produzieren viele ____. (exhaust fumes)', 'Abgase',
        'Cars produce a lot of exhaust fumes.', 'exhaust fumes'),
    qsi('Der ____ produziert Sauerstoff. (forest)', 'Wald',
        'The forest produces oxygen.', 'forest'),
    qsi('Wir müssen bedrohte Tiere ____. (protect)', 'schützen',
        'We must protect endangered animals.', 'protect',
        accepted: ['schuetzen']),
    qsi('Im Meer schwimmt zu viel ____. (plastic)', 'Plastik',
        'There is too much plastic floating in the sea.', 'plastic'),
    qsi('Wir sollten Wasser und Strom ____. (save)', 'sparen',
        'We should save water and electricity.', 'save'),
    qsi('Es geht um die ____ unserer Kinder. (future)', 'Zukunft',
        'It is about the future of our children.', 'future'),
  ],
);
...
final QuizContent questB22Konj2VergContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Ihr ____ uns warnen können. (haben → Konj. II)', 'hättet',
        'You (all) could have warned us.', 'ihr hättet … können'),
    qsi('Er ____ beinahe gewonnen. (haben → Konj. II)', 'hätte',
        'He would almost have won.', 'er hätte gewonnen'),
    qsi('Wir ____ das Haus fast gekauft. (haben → Konj. II)', 'hätten',
        'We almost bought the house.', 'wir hätten gekauft'),
    qsi('Ich ____ gern länger geblieben. (sein → Konj. II)', 'wäre',
        'I would have liked to stay longer.', 'ich wäre geblieben'),
    qsi('Sie ____ fast zu spät gekommen. (sein → Konj. II)', 'wäre',
        'She would almost have been late.', 'sie wäre gekommen'),
    qsi('Ohne dich ____ wir verloren gewesen. (sein → Konj. II)', 'wären',
        'Without you we would have been lost.', 'wir wären gewesen'),
    qsi('Du ____ früher aufstehen sollen. (haben → Konj. II)', 'hättest',
        'You should have got up earlier.', 'du hättest … sollen (aufstehen)'),
    qsi('Das ____ ich nie gedacht! (haben → Konj. II)', 'hätte',
        'I would never have thought that!', 'ich hätte gedacht'),
    qsi('Die Kinder ____ gern noch gespielt. (haben → Konj. II)', 'hätten',
        'The children would have liked to keep playing.',
        'sie hätten gespielt'),
    qsi('Ich ____ an deiner Stelle nichts gesagt. (haben → Konj. II)', 'hätte',
...
final QuizContent questB22IrrealContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Wenn ich mehr Geld ____, würde ich umziehen. (haben → Konj. II)',
        'hätte', 'If I had more money, I would move.', 'wenn ich hätte'),
    qsi('Wenn du früher gekommen ____, hättest du ihn getroffen. '
        '(sein → Konj. II)', 'wärst',
        'If you had come earlier, you would have met him.',
        'wenn du gekommen wärst', accepted: ['wärest', 'waerst']),
    qsi('Wenn wir ein Auto ____, würden wir dich abholen. (haben → Konj. II)',
        'hätten', 'If we had a car, we would pick you up.', 'wenn wir hätten'),
    qsi('Ich ____ gekommen, wenn du mich eingeladen hättest. (sein → Konj. II)',
        'wäre', 'I would have come if you had invited me.',
        'ich wäre gekommen'),
    qsi('Wenn sie könnte, ____ sie sofort kündigen. (würde)', 'würde',
        'If she could, she would quit immediately.', 'sie würde kündigen'),
    qsi('Wenn ihr Zeit ____, könntet ihr uns besuchen. (haben → Konj. II)',
        'hättet', 'If you (all) had time, you could visit us.',
        'wenn ihr hättet'),
    qsi('Was ____ du tun, wenn du im Lotto gewinnen würdest? (würde)',
        'würdest', 'What would you do if you won the lottery?',
        'was würdest du'),
    qsi('Wenn das Wetter besser ____, führen wir ans Meer. (sein → Konj. II)',
        'wäre', 'If the weather were better, we would go to the sea.',
        'wenn es wäre'),
    qsi('Ohne deine Hilfe ____ ich es nicht geschafft. (haben → Konj. II)',
        'hätte', 'Without your help I would not have managed it.',
        'ich hätte es geschafft'),
    qsi('Wenn es nicht regnen ____, gingen wir raus. (würde)', 'würde',
        'If it were not raining, we would go out.', 'wenn es würde'),
  ],
);
...
final QuizContent questB22GenitivPraepContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('____ des Konzerts klingelte ein Handy. (during)', 'Während',
        'During the concert a phone rang.', 'während (Konzert)',
        accepted: ['Waehrend']),
    qsi('____ der hohen Kosten sagte er zu. (despite)', 'Trotz',
        'Despite the high costs he agreed.', 'trotz (Kosten)'),
    qsi('____ des Streiks fahren keine Züge. (because of)', 'Wegen',
        'Because of the strike no trains are running.', 'wegen (Streik)'),
    qsi('____ der Stadt gibt es wenig Parkplätze. (inside)', 'Innerhalb',
        'Inside the city there are few parking spaces.', 'innerhalb (Stadt)'),
    qsi('____ der Öffnungszeiten ist niemand da. (outside)', 'Außerhalb',
        'Outside opening hours nobody is there.', 'außerhalb + Gen.',
        accepted: ['Ausserhalb']),
    qsi('____ seiner Krankheit arbeitete er weiter. (despite)', 'Trotz',
        'Despite his illness he kept working.', 'trotz (Krankheit)'),
    qsi('____ der Bauarbeiten ist die Straße gesperrt. (because of)', 'Wegen',
        'Because of the construction work the street is closed.',
        'wegen (Bauarbeiten)'),
    qsi('____ starker Nachfrage verlängern wir das Angebot. (due to)',
        'Aufgrund', 'Due to strong demand we extend the offer.',
        'aufgrund (Nachfrage)'),
    qsi('____ des Essens sollte man nicht telefonieren. (during)', 'Während',
        'During the meal one should not be on the phone.', 'während (Essen)',
        accepted: ['Waehrend']),
    qsi('____ eines Monats müssen Sie zahlen. (within)', 'Innerhalb',
        'You must pay within a month.', 'innerhalb (Monat)'),
  ],
);
...
final QuizContent questB22PartizipAttributContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Die vor kurzem ____ Brücke ist modern. (eröffnen → Partizip II)',
        'eröffnete', 'The recently opened bridge is modern.',
        'die eröffnete Brücke'),
    qsi('Der laut ____ Motor störte alle. (laufen → Partizip I)', 'laufende',
        'The loudly running engine disturbed everyone.', 'der laufende Motor'),
    qsi('Die von der Firma ____ Produkte sind teuer. '
        '(herstellen → Partizip II)', 'hergestellten',
        'The products made by the company are expensive.',
        'die hergestellten Produkte'),
    qsi('Das seit Jahren ____ Problem bleibt ungelöst. '
        '(bestehen → Partizip I)', 'bestehende',
        'The problem existing for years remains unsolved.',
        'das bestehende Problem'),
    qsi('Die gestern ____ Entscheidung überraschte alle. '
        '(treffen → Partizip II)', 'getroffene',
        'The decision made yesterday surprised everyone.',
        'die getroffene Entscheidung'),
    qsi('Der stark ____ Verkehr nervt die Anwohner. (zunehmen → Partizip I)',
        'zunehmende', 'The heavily increasing traffic annoys the residents.',
        'der zunehmende Verkehr'),
    qsi('Die neu ____ Wohnung ist hell. (renovieren → Partizip II)',
        'renovierte', 'The newly renovated flat is bright.',
        'die renovierte Wohnung'),
    qsi('Das schnell ____ Unternehmen sucht Personal. (wachsen → Partizip I)',
        'wachsende', 'The fast-growing company is hiring.',
        'das wachsende Unternehmen'),
    qsi('Die im Bericht ____ Zahlen stimmen nicht. (nennen → Partizip II)',
        'genannten', 'The figures mentioned in the report are wrong.',
        'die genannten Zahlen'),
    qsi('Das gut ____ Team gewann den Preis. (organisieren → Partizip II)',
        'organisierte', 'The well-organised team won the prize.',
...
final QuizContent questB22ModalpartikelnContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Das war ____ klar! (shared knowledge)', 'ja',
        'That was obvious (as we both know)!', 'ja (klar)'),
    qsi('Setz dich ____! (softening)', 'mal',
        'Have a seat (casually).', 'mal (setzen)'),
    qsi('Das Leben ist ____ so. (resignation: halt)', 'halt',
        "That's just how life is.", 'halt (resignation)'),
    qsi('Warum hast du ____ nichts gesagt? (interest: denn)', 'denn',
        'Why (on earth) did you not say anything?', 'denn (Frage)'),
    qsi('Das ist ____ nicht so schlimm! (reassurance: doch)', 'doch',
        "Come on, it's not that bad!", 'doch (Beruhigung)'),
    qsi('Was machst du ____ hier? (surprise: denn)', 'denn',
        'What are you doing here (surprised)?', 'denn (Überraschung)'),
    qsi('Wart ____ kurz! (softening)', 'mal',
        'Wait a moment (casually)!', 'mal (warten)'),
    qsi('Es ist ____ schon spät. (shared knowledge)', 'ja',
        'It is late, after all.', 'ja (spät)'),
    qsi('Dann bleiben wir ____ zu Hause. (resignation: eben)', 'eben',
        'Then we will just stay at home.', 'eben (bleiben)'),
    qsi('Du kannst es ____ versuchen. (go ahead: ruhig)', 'ruhig',
        'Feel free to try it.', 'ruhig (Vorschlag)'),
  ],
);
...
final QuizContent questB22FvgContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Der Lehrer bringt das Thema zur ____. (Sprache)', 'Sprache',
        'The teacher brings up the topic.', 'zur Sprache bringen'),
    qsi('Das neue Gesetz tritt am Montag in ____. (Kraft)', 'Kraft',
        'The new law comes into force on Monday.', 'in Kraft treten'),
    qsi('Wir nehmen Ihre Kritik zur ____. (Kenntnis)', 'Kenntnis',
        'We take note of your criticism.', 'zur Kenntnis nehmen'),
    qsi('Ein teureres Hotel kommt nicht in ____. (Frage)', 'Frage',
        'A more expensive hotel is out of the question.', 'in Frage kommen'),
    qsi('Ich möchte eine Bitte an Sie ____. (richten)', 'richten',
        'I would like to make a request to you.', 'eine Bitte richten'),
    qsi('Wir müssen Rücksicht auf die Kinder ____. (nehmen)', 'nehmen',
        'We must show consideration for the children.', 'Rücksicht nehmen'),
    qsi('Das Konzert findet am Samstag ____. (statt)', 'statt',
        'The concert takes place on Saturday.', 'stattfinden'),
    qsi('Geld ____ dabei eine große Rolle. (spielen)', 'spielt',
        'Money plays a big role in this.', 'eine Rolle spielen'),
    qsi('Der Chef stellt das Ergebnis in ____. (Frage)', 'Frage',
        'The boss questions the result.', 'in Frage stellen'),
    qsi('Wir nehmen ____ von unseren Freunden. (Abschied)', 'Abschied',
        'We say farewell to our friends.', 'Abschied nehmen'),
  ],
);
...
final QuizContent questB22KonzessivContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('____ er wenig Zeit hat, hilft er uns. (although)', 'Obwohl',
        'Although he has little time, he helps us.', 'obwohl (Zeit)'),
    qsi('Das Wetter war schlecht. ____ hatten wir Spaß. (nevertheless)',
        'Trotzdem', 'The weather was bad. Nevertheless we had fun.',
        'trotzdem (Spaß)'),
    qsi('Sie nahm den Job an, ____ das Gehalt niedrig war. (although)',
        'obwohl', 'She took the job although the salary was low.',
        'obwohl (Gehalt)'),
    qsi('____ ich müde bin, arbeite ich weiter. (although)', 'Obwohl',
        'Although I am tired, I keep working.', 'obwohl (müde)'),
    qsi('____ das Buch dick ist, liest es sich schnell. (literary although)',
        'Obgleich', 'Although the book is thick, it reads quickly.',
        'obgleich'),
    qsi('Es war ____ kalt, aber sonnig. (zwar … aber)', 'zwar',
        'It was admittedly cold, but sunny.', 'zwar … aber (kalt)'),
    qsi('Er blieb ruhig, ____ man ihn provozierte. (although)', 'obwohl',
        'He stayed calm although he was provoked.', 'obwohl (provoziert)'),
    qsi('Der Plan ist riskant. ____ versuchen wir es. (nevertheless)',
        'Trotzdem', 'The plan is risky. Nevertheless we will try.',
        'trotzdem (riskant)'),
    qsi('____ es teuer ist, lohnt sich die Reise. (literary although)',
        'Wenngleich', 'Although it is expensive, the trip is worth it.',
        'wenngleich'),
    qsi('Sie ist glücklich, ____ sie wenig besitzt. (although)', 'obwohl',
        'She is happy although she owns little.', 'obwohl (besitzt)'),
  ],
);
