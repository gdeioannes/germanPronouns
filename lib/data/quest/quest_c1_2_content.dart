...
final QuizContent questC12KulturContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Die ____ mit dem Thema war intensiv. (engagement/debate)',
        ...
        'engagement'),
    qsi('Der Roman wurde in zwanzig Sprachen ____. (translated)', 'übersetzt',
        'The novel was translated into twenty languages.', 'translated',
        accepted: ['uebersetzt']),
    qsi('Die Ausstellung zeigt zeitgenössische ____. (art)', 'Kunst',
        'The exhibition shows contemporary art.', 'art'),
    qsi('Das Theaterstück bekam hervorragende ____. (reviews)', 'Kritiken',
        'The play received excellent reviews.', 'reviews'),
    qsi('Digitale Medien verändern die ____. (public sphere)',
        'Öffentlichkeit', 'Digital media are changing the public sphere.',
        'public sphere', accepted: ['Oeffentlichkeit']),
    qsi('Der Autor spielt mit kulturellen ____. (allusions)', 'Anspielungen',
        'The author plays with cultural allusions.', 'allusions'),
    qsi('Das Publikum reagierte mit großer ____. (enthusiasm)',
        'Begeisterung', 'The audience reacted with great enthusiasm.',
        'enthusiasm'),
    qsi('Die Sendung will Wissen unterhaltsam ____. (present/convey)',
        'präsentieren', 'The show wants to present knowledge entertainingly.',
        'present', accepted: ['praesentieren']),
    qsi('Der Verlag ____ nur wenige Romane pro Jahr. (publishes)',
        'veröffentlicht', 'The publisher publishes only a few novels a year.',
        'publish', accepted: ['veroeffentlicht']),
    qsi('Das Festival fördert den kulturellen ____. (exchange)', 'Austausch',
        'The festival promotes cultural exchange.', 'exchange'),
    qsi('Ihre Werke gelten als bedeutendes kulturelles ____. (heritage)',
        'Erbe', 'Her works count as important cultural heritage.', 'heritage'),
  ],
);
...
final QuizContent questC12ModalVermutungContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Der Brief ____ inzwischen angekommen sein. (probably)', 'dürfte',
        'The letter has probably arrived by now.', 'dürfte (Brief)'),
    qsi('Niemand öffnet. Sie ____ nicht zu Hause sein. (cannot)', 'kann',
        'Nobody answers. She cannot be at home.', 'kann nicht (impossible)'),
    qsi('Das Paket ____ schon morgen ankommen. (might)', 'könnte',
        'The parcel might arrive as early as tomorrow.', 'könnte (Paket)'),
    qsi('Er kennt jede Straße. Er ____ hier aufgewachsen sein. '
        '(almost certain)', 'muss',
        'He knows every street. He must have grown up here.',
        'muss (aufgewachsen)'),
    qsi('Sie ____ etwa vierzig sein. (probably)', 'dürfte',
        'She is probably about forty.', 'dürfte (Alter)'),
    qsi('Das ____ stimmen, aber sicher bin ich nicht. (may)', 'mag',
        'That may be true, but I am not sure.', 'mag (vielleicht)'),
    qsi('Der Chef ist nicht da. Er ____ im Urlaub sein. (might)', 'könnte',
        'The boss is not here. He might be on holiday.', 'könnte (Urlaub)'),
    qsi('So ein Fehler ____ jedem passieren. (can)', 'kann',
        'Such a mistake can happen to anyone.', 'kann (jedem)'),
    qsi('Nach der langen Reise ____ sie müde sein. (almost certain)', 'muss',
        'After the long journey she must be tired.', 'muss (müde)'),
    qsi('Das Projekt ____ bis Freitag fertig sein. (probably)', 'dürfte',
        'The project should be finished by Friday.', 'dürfte (Projekt)'),
  ],
);
...
final QuizContent questC12ModalHoerensagenContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Die Insel ____ wunderschön sein. (people say)', 'soll',
        'The island is said to be beautiful.', 'soll (Insel)'),
    qsi('Er ____ den Marathon in drei Stunden gelaufen sein. (he claims)',
        'will', 'He claims to have run the marathon in three hours.',
        'will (Marathon)'),
    qsi('Die Firma ____ vor der Pleite stehen. (people say)', 'soll',
        'The company is said to be near bankruptcy.', 'soll (Firma)'),
    qsi('Sie ____ die Wahrheit gesagt haben. (she claims)', 'will',
        'She claims to have told the truth.', 'will (Wahrheit)'),
    qsi('Das Hotel ____ fünf Sterne haben. (people say)', 'soll',
        'The hotel is said to have five stars.', 'soll (Hotel)'),
    qsi('Der Zeuge ____ alles genau beobachtet haben. (he claims)', 'will',
        'The witness claims to have observed everything closely.',
        'will (Zeuge)'),
    qsi('Das Medikament ____ sehr wirksam sein. (people say)', 'soll',
        'The medicine is said to be very effective.', 'soll (Medikament)'),
    qsi('Niemand ____ etwas bemerkt haben. (they claim)', 'will',
        'Nobody claims to have noticed anything.', 'will (niemand)'),
    qsi('Der neue Chef ____ sehr streng sein. (people say)', 'soll',
        'The new boss is said to be very strict.', 'soll (Chef)'),
    qsi('Sie ____ das Bild selbst gemalt haben. (she claims)', 'will',
        'She claims to have painted the picture herself.', 'will (Bild)'),
  ],
);
...
final QuizContent questC12WortbildungVorContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Der Spiegel ist in tausend Stücke zer____. (sprungen)', 'sprungen',
        'The mirror shattered into a thousand pieces.', 'zersprungen'),
    qsi('Ich habe den Termin völlig ver____. (gessen)', 'gessen',
        'I completely forgot the appointment.', 'vergessen'),
    qsi('Die Forscher konnten den Code ent____. (schlüsseln)', 'schlüsseln',
        'The researchers managed to decode the code.', 'entschlüsseln',
        accepted: ['schluesseln']),
    qsi('Er hat die Frage leider miss____. (verstanden)', 'verstanden',
        'Unfortunately he misunderstood the question.', 'missverstanden'),
    qsi('Sie hat ihr Ziel endlich er____. (reicht)', 'reicht',
        'She finally reached her goal.', 'erreicht'),
    qsi('Bitte be____ Sie den Rasen nicht. (treten)', 'treten',
        'Please do not step on the lawn.', 'betreten'),
    qsi('Der Fleck lässt sich leicht ent____. (fernen)', 'fernen',
        'The stain is easy to remove.', 'entfernen'),
    qsi('Das Eis ist in der Sonne zer____. (laufen)', 'laufen',
        'The ice cream melted apart in the sun.', 'zerlaufen'),
    qsi('Wir haben den Abend sehr ge____. (nossen)', 'nossen',
        'We enjoyed the evening very much.', 'genossen'),
    qsi('Der Zug ist dem Unwetter knapp ent____. (kommen)', 'kommen',
        'The train narrowly escaped the storm.', 'entkommen'),
  ],
);
...
final QuizContent questC12WortbildungNachContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Hoffnung → hoffnungs____ (full of hope)', 'voll', 'hopeful',
        '-voll'),
    qsi('krank → die ____ (illness)', 'Krankheit', 'illness',
        '-heit (krank)'),
    qsi('einsam → die ____ (loneliness)', 'Einsamkeit', 'loneliness',
        '-keit (einsam)'),
    qsi('lösen → die ____ (solution)', 'Lösung', 'solution', '-ung (lösen)',
        accepted: ['Loesung']),
    qsi('Freund → die ____ (friendship)', 'Freundschaft', 'friendship',
        '-schaft'),
    qsi('Kind → kind____ (childlike)', 'lich', 'childlike',
        '-lich (kindlich)'),
    qsi('Wolke → wolken____ (cloudless)', 'los', 'cloudless',
        '-los (wolkenlos)'),
    qsi('Wert → wert____ (valuable)', 'voll', 'valuable', '-voll (wertvoll)'),
    qsi('Angst → ängst____ (anxious)', 'lich', 'anxious',
        '-lich (ängstlich)'),
    qsi('Salz → salz____ (salty)', 'ig', 'salty', '-ig (salzig)'),
    qsi('Traum → traum____ (dreamlike, wonderful)', 'haft', 'dreamlike',
        '-haft (traumhaft)'),
  ],
);
...
final QuizContent questC12RedewendungenContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Da hast du den Nagel auf den ____ getroffen. (hit the nail)', 'Kopf',
        'You hit the nail on the head.', 'den Nagel auf den Kopf treffen'),
    qsi('Bei Mathe verstehe ich nur ____. (all Greek to me)', 'Bahnhof',
        'Maths is all Greek to me.', 'nur Bahnhof verstehen'),
    qsi('Das neue Auto geht ganz schön ins ____. (very expensive)', 'Geld',
        'The new car really eats into the money.', 'ins Geld gehen'),
    qsi('Er hat mal wieder Schwein ____. (was lucky)', 'gehabt',
        'He got lucky once again.', 'Schwein gehabt'),
    qsi('Jetzt schlägt’s aber ____! (that’s the limit)', 'dreizehn',
        'Now that really is the limit!', 'jetzt schlägt’s dreizehn'),
    qsi('Er ist mit dem falschen Fuß ____. (bad mood since morning)',
        'aufgestanden', 'He got up on the wrong side of the bed.',
        'mit dem falschen Fuß aufstehen'),
    qsi('Fußball ist einfach nicht mein ____. (not my thing)', 'Bier',
        'Football is just not my thing.', 'nicht mein Bier'),
    qsi('Kauf nicht die Katze im ____! (buy blind)', 'Sack',
        'Don’t buy a pig in a poke!', 'die Katze im Sack kaufen'),
    qsi('Wir sitzen doch alle im selben ____. (same situation)', 'Boot',
        'We are all in the same boat.', 'im selben Boot sitzen'),
    qsi('Er wirft das Geld zum ____ hinaus. (wastes money)', 'Fenster',
...
final QuizContent questC12KohaesionContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Zuerst kam er zu spät. ____ vergaß er die Unterlagen. (in addition)',
        'Außerdem', 'First he was late. In addition he forgot the documents.',
        'außerdem (Kohäsion)', accepted: ['Ausserdem']),
    qsi('Die Preise steigen. ____ sinken die Löhne. (at the same time)',
        'Gleichzeitig', 'Prices are rising. At the same time wages are '
            'falling.', 'gleichzeitig'),
    qsi('Er versprach zu helfen. ____ hielt er sein Wort. (indeed)',
        'Tatsächlich', 'He promised to help. And indeed he kept his word.',
        'tatsächlich', accepted: ['Tatsaechlich']),
    qsi('Viele lehnen den Plan ab. ____ gibt es auch Zustimmung. (yet)',
        'Dennoch', 'Many reject the plan. Yet there is also approval.',
        'dennoch (Zustimmung)'),
    qsi('Das Experiment scheiterte. ____ lernten wir viel. '
        '(nonetheless, formal)', 'Gleichwohl',
        'The experiment failed. Nonetheless we learned a lot.', 'gleichwohl'),
    qsi('Er hat nicht bezahlt. ____ wurde der Vertrag gekündigt. '
        '(consequently)', 'Folglich',
        'He did not pay. Consequently the contract was terminated.',
        'folglich (Kohäsion)'),
    qsi('Erst prüfen wir die Daten. ____ ziehen wir Schlüsse. (afterwards)',
        'Anschließend', 'First we check the data. Afterwards we draw '
            'conclusions.', 'anschließend', accepted: ['Anschliessend']),
    qsi('Zum einen fehlt Geld, zum ____ fehlt Zeit. (zum einen … zum anderen)',
        'anderen', 'For one thing money is lacking, for another time.',
        'zum einen … zum anderen'),
    qsi('Die Zahlen sind schlecht. Der Grund ____ ist die Krise. (for that)',
        'dafür', 'The figures are bad. The reason for that is the crisis.',
        'dafür', accepted: ['dafuer']),
    qsi('Er sprach lange. ____ kam er zum Punkt. (finally)', 'Schließlich',
        'He spoke for a long time. Finally he got to the point.',
        'schließlich', accepted: ['Schliesslich']),
  ],
);
