...
final QuizContent questA22WechselWoContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Die Schuhe stehen neben ____ Tür. (die)', 'der',
        'The shoes are next to the door.', 'neben + Dativ'),
    qsi('Der Garten liegt hinter ____ Haus. (das)', 'dem',
        'The garden is behind the house.', 'hinter + Dativ'),
    qsi('Der Tisch steht zwischen ____ Betten. (die, Plural)', 'den',
        'The table stands between the beds.', 'zwischen + Dativ'),
    qsi('Wir warten an ____ Bahnhof. (der)', 'dem',
        'We wait at the station.', 'an + Dativ (m.)'),
    qsi('Die Kinder spielen in ____ Garten. (der)', 'dem',
        'The children play in the garden.', 'in + Dativ (m.)'),
    qsi('Der Hund schläft unter ____ Stuhl. (der)', 'dem',
        'The dog sleeps under the chair.', 'unter + Dativ (m.)'),
    qsi('Das Restaurant liegt neben ____ Kino. (das)', 'dem',
        'The restaurant is next to the cinema.', 'neben + Dativ (n.)'),
    qsi('Die Uhr hängt über ____ Tür. (die)', 'der',
        'The clock hangs above the door.', 'über + Dativ (f.)'),
    qsi('Das Fahrrad steht hinter ____ Garage. (die)', 'der',
        'The bike is behind the garage.', 'hinter + Dativ (f.)'),
  ],
);
...
final QuizContent questA22WechselWohinContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Ich stelle die Vase auf ____ Regal. (das)', 'das',
        'I put the vase on the shelf.', 'auf + Akkusativ (n.)'),
    qsi('Er hängt die Uhr über ____ Tür. (die)', 'die',
        'He hangs the clock above the door.', 'über + Akkusativ'),
    qsi('Wir fahren in ____ Stadt. (die)', 'die',
        'We drive into the city.', 'in + Akkusativ (f.)'),
    qsi('Der Hund läuft hinter ____ Baum. (der)', 'den',
        'The dog runs behind the tree.', 'hinter + Akkusativ'),
    qsi('Ich lege den Brief zwischen ____ Bücher. (die, Plural)', 'die',
        'I put the letter between the books.', 'zwischen + Akkusativ'),
    qsi('Sie stellt die Milch in ____ Kühlschrank. (der)', 'den',
        'She puts the milk in the fridge.', 'in + Akkusativ (m.)'),
    qsi('Das Kind springt in ____ Wasser. (das)', 'das',
        'The child jumps into the water.', 'in + Akkusativ (n.)'),
    qsi('Ich setze mich an ____ Fenster. (das)', 'das',
        'I sit down by the window.', 'an + Akkusativ (n.)'),
    qsi('Stell den Stuhl vor ____ Schreibtisch. (der)', 'den',
        'Put the chair in front of the desk.', 'vor + Akkusativ'),
  ],
);
...
final QuizContent questA22ReflexivContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Ich wasche ____ jeden Morgen. (ich)', 'mich',
        'I wash (myself) every morning.', 'ich → mich (waschen)'),
    qsi('Interessierst du ____ für Sport? (du)', 'dich',
        'Are you interested in sport?', 'du → dich (interessieren)'),
    qsi('Sie duscht ____ am Abend. (sie Sg.)', 'sich',
        'She showers in the evening.', 'sie → sich (duschen)'),
    qsi('Wir freuen ____ auf den Urlaub. (wir)', 'uns',
        'We are looking forward to the holiday.', 'wir → uns (freuen)'),
    qsi('Beeilt ____, der Bus kommt! (ihr)', 'euch',
        'Hurry up, the bus is coming!', 'ihr → euch (beeilen)'),
    qsi('Er zieht ____ schnell an. (er)', 'sich',
        'He gets dressed quickly.', 'er → sich (anziehen)'),
    qsi('Ich erinnere ____ an den Sommer. (ich)', 'mich',
        'I remember the summer.', 'ich → mich (erinnern)'),
    qsi('Setzen Sie ____ bitte! (Sie)', 'sich',
        'Please sit down!', 'Sie → sich (setzen)'),
    qsi('Wir sehen ____ morgen. (wir)', 'uns',
        'We will see each other tomorrow.', 'wir → uns (sehen)'),
  ],
);
...
final QuizContent questA22WeilContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Er geht zum Arzt, weil er Fieber ____. (haben)', 'hat',
        'He goes to the doctor because he has a fever.', 'weil … hat'),
    qsi('Ich lerne viel, weil ich die Prüfung bestehen ____. (wollen)', 'will',
        'I study a lot because I want to pass the exam.', 'weil … will'),
    qsi('Wir bleiben drinnen, weil es kalt ____. (sein)', 'ist',
        'We stay inside because it is cold.', 'weil … ist (kalt)'),
    qsi('Sie ist glücklich, weil sie Urlaub ____. (haben)', 'hat',
        'She is happy because she is on holiday.', 'weil … hat (Urlaub)'),
    qsi('Ich esse einen Apfel, weil ich Hunger ____. (haben)', 'habe',
        'I eat an apple because I am hungry.', 'weil … habe'),
    qsi('Er kommt zu spät, weil der Bus nicht ____. (kommen)', 'kommt',
        'He is late because the bus is not coming.', 'weil … kommt'),
    qsi('Wir fahren ans Meer, weil wir schwimmen ____. (möchten)', 'möchten',
        'We go to the sea because we want to swim.', 'weil … möchten'),
    qsi('Ich rufe dich an, weil ich eine Frage ____. (haben)', 'habe',
        'I am calling you because I have a question.', 'weil … habe (Frage)'),
    qsi('Sie trägt eine Jacke, weil es windig ____. (sein)', 'ist',
        'She wears a jacket because it is windy.', 'weil … ist (windig)'),
    qsi('Er spart Geld, weil er ein Auto kaufen ____. (wollen)', 'will',
        'He saves money because he wants to buy a car.', 'weil … will (kaufen)'),
  ],
);
...
final QuizContent questA22DassContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Ich denke, dass Deutsch nicht so schwer ____. (sein)', 'ist',
        'I think that German is not so hard.', 'dass … ist (schwer)'),
    qsi('Er sagt, dass er keine Zeit ____. (haben)', 'hat',
        'He says that he has no time.', 'dass … hat (Zeit)'),
    qsi('Wir hoffen, dass ihr bald ____. (kommen)', 'kommt',
        'We hope that you (all) come soon.', 'dass … kommt (ihr)'),
    qsi('Ich weiß, dass du mir ____. (helfen)', 'hilfst',
        'I know that you will help me.', 'dass … hilfst'),
    qsi('Sie glaubt, dass wir zu viel ____. (arbeiten)', 'arbeiten',
        'She thinks that we work too much.', 'dass … arbeiten'),
    qsi('Es ist schade, dass du nicht kommen ____. (können)', 'kannst',
        'It is a pity that you cannot come.', 'dass … kannst'),
    qsi('Ich finde, dass das Essen gut ____. (schmecken)', 'schmeckt',
        'I find that the food tastes good.', 'dass … schmeckt'),
    qsi('Er hofft, dass das Wetter besser ____. (werden)', 'wird',
        'He hopes that the weather gets better.', 'dass … wird'),
    qsi('Wir wissen, dass sie viel Sport ____. (machen, sie Sg.)', 'macht',
        'We know that she does a lot of sport.', 'dass … macht'),
    qsi('Ich glaube, dass ich morgen frei ____. (haben)', 'habe',
        'I think that I am free tomorrow.', 'dass … habe (frei)'),
  ],
);
...
final QuizContent questA22GesundheitContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Ich habe ____ — zu viel Schokolade! (stomach ache)', 'Bauchschmerzen',
        'I have a stomach ache — too much chocolate!', 'stomach ache'),
    qsi('Mein ____ tut weh, ich kann kaum sprechen. (throat)', 'Hals',
        'My throat hurts, I can hardly speak.', 'throat'),
    qsi('Ich habe 39 Grad — ich habe ____. (fever)', 'Fieber',
        'I have a temperature of 39 — I have a fever.', 'fever'),
    qsi('Der Arzt gibt mir ein ____ für Tabletten. (prescription)', 'Rezept',
        'The doctor gives me a prescription for tablets.', 'prescription'),
    qsi('Ich nehme ein ____ gegen die Schmerzen. (medicine)', 'Medikament',
        'I take a medicine for the pain.', 'medicine'),
    qsi('Ich sehe mit den ____. (eyes)', 'Augen',
        'I see with my eyes.', 'eyes'),
    qsi('Ich höre mit den ____. (ears)', 'Ohren',
        'I hear with my ears.', 'ears'),
    qsi('Ich schreibe mit der ____. (hand)', 'Hand',
        'I write with my hand.', 'hand'),
    qsi('Ich habe eine ____ und muss niesen. (a cold)', 'Erkältung',
        'I have a cold and have to sneeze.', 'a cold',
        accepted: ['Erkaeltung']),
    qsi('Der ____ tut weh — die Musik war zu laut! (head)', 'Kopf',
        'My head hurts — the music was too loud!', 'head'),
  ],
);
...
final QuizContent questA22ImperativContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('____ viel Wasser! (trinken, du)', 'Trink', 'Drink lots of water!',
        'trinken → Trink!'),
    qsi('____ bitte das Fenster! (öffnen, du)', 'Öffne',
        'Open the window, please!', 'öffnen → Öffne!',
        accepted: ['Oeffne']),
    qsi('____ Sie bitte langsam. (fahren, Sie)', 'Fahren',
        'Please drive slowly.', 'fahren → Fahren Sie!'),
    qsi('____ eure Hausaufgaben! (machen, ihr)', 'Macht',
        'Do your homework!', 'machen → Macht!'),
    qsi('____ ruhig, bitte! (sein, du)', 'Sei',
        'Be calm, please!', 'sein → Sei!'),
    qsi('____ den Bus, er kommt gleich! (nehmen, du)', 'Nimm',
        'Take the bus, it is coming soon!', 'nehmen → Nimm!'),
    qsi('____ Sie mir bitte die Rechnung. (bringen, Sie)', 'Bringen',
        'Please bring me the bill.', 'bringen → Bringen Sie!'),
    qsi('____ langsamer, Kinder! (laufen, ihr)', 'Lauft',
        'Run more slowly, children!', 'laufen → Lauft!'),
    qsi('____ mir bitte! (helfen, du)', 'Hilf',
        'Help me, please!', 'helfen → Hilf!'),
    qsi('____ keine Angst! (haben, du)', 'Hab',
        "Don't be afraid!", 'haben → Hab!',
        accepted: ['Habe']),
    qsi('____ mehr Obst! (essen, du)', 'Iss',
        'Eat more fruit!', 'essen → Iss!'),
  ],
);
...
final QuizContent questA22SuperlativContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Der Mount Everest ist am ____. (hoch)', 'höchsten',
        'Mount Everest is the highest.', 'hoch → am höchsten',
        accepted: ['hoechsten']),
    qsi('Mein Opa ist am ____ in der Familie. (alt)', 'ältesten',
        'My grandpa is the oldest in the family.', 'alt → am ältesten',
        accepted: ['aeltesten']),
    qsi('Im Juli ist es am ____. (warm)', 'wärmsten',
        'In July it is warmest.', 'warm → am wärmsten',
        accepted: ['waermsten']),
    qsi('Diese Übung ist am ____. (leicht)', 'leichtesten',
        'This exercise is the easiest.', 'leicht → am leichtesten'),
    qsi('Er isst am ____ von allen. (viel)', 'meisten',
        'He eats the most of all.', 'viel → am meisten'),
    qsi('Das Kino ist am ____ von hier. (weit)', 'weitesten',
        'The cinema is the furthest from here.', 'weit → am weitesten'),
    qsi('Der Januar ist am ____. (kalt)', 'kältesten',
        'January is the coldest.', 'kalt → am kältesten',
        accepted: ['kaeltesten']),
    qsi('Dieses Auto fährt am ____. (langsam)', 'langsamsten',
        'This car drives the slowest.', 'langsam → am langsamsten'),
    qsi('Das Sofa ist am ____. (bequem)', 'bequemsten',
        'The sofa is the most comfortable.', 'bequem → am bequemsten'),
    qsi('Die Bäckerei ist am ____. (nah)', 'nächsten',
        'The bakery is the nearest.', 'nah → am nächsten',
        accepted: ['naechsten']),
  ],
);
