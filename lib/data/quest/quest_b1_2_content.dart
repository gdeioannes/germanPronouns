...
final QuizContent questB12TechnikContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Der ____ von meinem Laptop ist kaputt. (screen)', 'Bildschirm',
        'The screen of my laptop is broken.', 'screen'),
    qsi('Ich habe mein ____ schon wieder vergessen. (password)', 'Passwort',
        'I have forgotten my password again.', 'password'),
    qsi('Kannst du das Dokument bitte ____? (print)', 'drucken',
        'Can you print the document, please?', 'print'),
    qsi('Das ____ im Hotel ist kostenlos. (Wi-Fi)', 'WLAN',
        'The Wi-Fi at the hotel is free.', 'Wi-Fi'),
    qsi('Mein ____ ist fast leer — wo ist das Ladekabel? (battery)', 'Akku',
        'My battery is almost empty — where is the charger?', 'battery'),
    qsi('Ich schreibe dir morgen eine ____. (e-mail)', 'E-Mail',
        'I will write you an e-mail tomorrow.', 'e-mail'),
    qsi('Du musst nur auf den Link ____. (click)', 'klicken',
        'You just have to click on the link.', 'click'),
    qsi('Ich muss die Fotos noch ____. (upload)', 'hochladen',
        'I still have to upload the photos.', 'upload'),
    qsi('Ich schalte den Computer am Abend ____. (off)', 'aus',
        'I switch the computer off in the evening.', 'switch off (aus)'),
    qsi('Diese ____ hat viele gute Informationen. (website)', 'Webseite',
        'This website has a lot of good information.', 'website'),
  ],
);
...
final QuizContent questB12PraetRegContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Das Kind ____ laut. (lachen)', 'lachte', 'The child laughed loudly.',
        'lachen → lachte'),
    qsi('Die Kinder ____ im Garten. (spielen)', 'spielten',
        'The children played in the garden.', 'spielen → spielten'),
    qsi('Sie ____ ein neues Kleid. (kaufen)', 'kaufte',
        'She bought a new dress.', 'kaufen → kaufte'),
    qsi('Er ____ mich nach dem Weg. (fragen)', 'fragte',
        'He asked me the way.', 'fragen → fragte'),
    qsi('Wir ____ die ganze Nacht Musik. (hören)', 'hörten',
        'We listened to music all night.', 'hören → hörten'),
    qsi('Ich ____ schnell meine Hausaufgaben. (machen)', 'machte',
        'I quickly did my homework.', 'machen → machte'),
    qsi('Sie ____ eine Stunde auf den Bus. (warten)', 'wartete',
        'She waited an hour for the bus.', 'warten → wartete'),
    qsi('Er ____ langsam die Tür. (öffnen)', 'öffnete',
        'He slowly opened the door.', 'öffnen → öffnete',
        accepted: ['oeffnete']),
    qsi('Meine Mutter ____ eine Suppe. (kochen)', 'kochte',
        'My mother cooked a soup.', 'kochen → kochte'),
    qsi('Wir ____ lange über das Problem. (reden)', 'redeten',
        'We talked about the problem for a long time.', 'reden → redeten'),
    qsi('Der Film ____ zwei Stunden. (dauern)', 'dauerte',
        'The film lasted two hours.', 'dauern → dauerte'),
  ],
);
...
final QuizContent questB12PraetUnregContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Er ____ mir das Buch. (geben → gab)', 'gab', 'He gave me the book.',
        'geben → gab'),
    qsi('Wir ____ mit dem Zug nach Wien. (fahren → fuhr)', 'fuhren',
        'We went to Vienna by train.', 'fahren → fuhren'),
    qsi('Er ____ den letzten Bus. (nehmen → nahm)', 'nahm',
        'He took the last bus.', 'nehmen → nahm'),
    qsi('Sie ____ nur einen Salat. (essen → aß)', 'aß',
        'She only ate a salad.', 'essen → aß',
        accepted: ['ass']),
    qsi('Ich ____ eine Tasse Tee. (trinken → trank)', 'trank',
        'I drank a cup of tea.', 'trinken → trank'),
    qsi('Er ____ ihr einen langen Brief. (schreiben → schrieb)', 'schrieb',
        'He wrote her a long letter.', 'schreiben → schrieb'),
    qsi('Sie ____ das Buch in zwei Tagen. (lesen → las)', 'las',
        'She read the book in two days.', 'lesen → las'),
    qsi('Das Baby ____ zehn Stunden. (schlafen → schlief)', 'schlief',
        'The baby slept for ten hours.', 'schlafen → schlief'),
    qsi('Wir ____ bis Mitternacht. (bleiben → blieb)', 'blieben',
        'We stayed until midnight.', 'bleiben → blieben'),
    qsi('Es ____ langsam dunkel. (werden → wurde)', 'wurde',
        'It slowly got dark.', 'werden → wurde'),
    qsi('Ich ____ die Antwort nicht. (wissen → wusste)', 'wusste',
        'I did not know the answer.', 'wissen → wusste'),
  ],
);
...
final QuizContent questB12PassivContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Die Pizza ____ frisch gebacken. (werden)', 'wird',
        'The pizza is baked fresh.', 'wird gebacken'),
    qsi('Die Zimmer ____ jeden Tag geputzt. (werden, Pl.)', 'werden',
        'The rooms are cleaned every day.', 'werden geputzt'),
    qsi('Der Müll ____ am Montag abgeholt. (werden)', 'wird',
        'The rubbish is collected on Monday.', 'wird abgeholt'),
    qsi('In der Schweiz ____ vier Sprachen gesprochen. (werden, Pl.)',
        'werden', 'Four languages are spoken in Switzerland.',
        'werden gesprochen'),
    qsi('Das Essen ____ um sieben serviert. (werden)', 'wird',
        'The food is served at seven.', 'wird serviert'),
    qsi('Die Rechnungen ____ online bezahlt. (werden, Pl.)', 'werden',
        'The bills are paid online.', 'werden bezahlt'),
    qsi('Der Kuchen ____ mit Schokolade gemacht. (werden)', 'wird',
        'The cake is made with chocolate.', 'wird gemacht'),
    qsi('Die Tür ____ um acht Uhr geöffnet. (werden)', 'wird',
        'The door is opened at eight.', 'wird geöffnet'),
    qsi('Die Pakete ____ morgen geliefert. (werden, Pl.)', 'werden',
        'The parcels will be delivered tomorrow.', 'werden geliefert'),
    qsi('Das Lied ____ oft im Radio gespielt. (werden)', 'wird',
        'The song is often played on the radio.', 'wird gespielt'),
  ],
);
...
final QuizContent questB12PassivPraetContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Der Brief ____ sofort geschickt. (werden → wurde)', 'wurde',
        'The letter was sent immediately.', 'wurde geschickt'),
    qsi('Die Fenster ____ gestern geputzt. (werden → wurden, Pl.)', 'wurden',
        'The windows were cleaned yesterday.', 'wurden geputzt'),
    qsi('Das Telefon ____ 1876 erfunden. (werden → wurde)', 'wurde',
        'The telephone was invented in 1876.', 'wurde erfunden'),
    qsi('Die Stadt ____ vor tausend Jahren gegründet. (werden → wurde)',
        'wurde', 'The city was founded a thousand years ago.',
        'wurde gegründet'),
    qsi('Die Gäste ____ herzlich begrüßt. (werden → wurden, Pl.)', 'wurden',
        'The guests were warmly welcomed.', 'wurden begrüßt'),
    qsi('Das Museum ____ letztes Jahr renoviert. (werden → wurde)', 'wurde',
        'The museum was renovated last year.', 'wurde renoviert'),
    qsi('Die Bilder ____ teuer verkauft. (werden → wurden, Pl.)', 'wurden',
        'The paintings were sold at a high price.', 'wurden verkauft'),
    qsi('Der Fehler ____ schnell korrigiert. (werden → wurde)', 'wurde',
        'The mistake was corrected quickly.', 'wurde korrigiert'),
    qsi('Ich ____ zur Party eingeladen. (werden → wurde)', 'wurde',
        'I was invited to the party.', 'wurde eingeladen'),
    qsi('Die Straße ____ letzte Woche gesperrt. (werden → wurde)', 'wurde',
        'The street was closed last week.', 'wurde gesperrt'),
  ],
);
...
final QuizContent questB12NDeklinationContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Fragen Sie den ____ dort! (der Herr)', 'Herrn',
        'Ask the gentleman over there!', 'den Herrn'),
    qsi('Ich gebe dem ____ die Hand. (der Präsident)', 'Präsidenten',
        'I shake the president\'s hand.', 'dem Präsidenten'),
    qsi('Das Foto des ____ hängt im Flur. (der Junge)', 'Jungen',
        'The photo of the boy hangs in the hall.', 'des Jungen'),
    qsi('Wir besuchen einen wichtigen ____. (der Kunde)', 'Kunden',
        'We visit an important customer.', 'einen Kunden'),
    qsi('Der Zoo hat einen neuen ____. (der Elefant)', 'Elefanten',
        'The zoo has a new elephant.', 'einen Elefanten'),
    qsi('Ich spreche mit dem ____. (der Polizist)', 'Polizisten',
        'I talk to the police officer.', 'dem Polizisten'),
    qsi('Kennst du den ____ da drüben? (der Tourist)', 'Touristen',
        'Do you know the tourist over there?', 'den Touristen'),
    qsi('Wir sehen einen ____ im Zoo. (der Löwe)', 'Löwen',
        'We see a lion at the zoo.', 'einen Löwen',
        accepted: ['Loewen']),
    qsi('Das Büro des ____ ist im ersten Stock. (der Experte)', 'Experten',
        'The expert\'s office is on the first floor.', 'des Experten'),
    qsi('Sie hilft dem ____ mit dem Formular. (der Patient)', 'Patienten',
        'She helps the patient with the form.', 'dem Patienten'),
  ],
);
...
final QuizContent questB12InfinitivContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Sie treibt Sport, um fit zu ____. (bleiben)', 'bleiben',
        'She does sport in order to stay fit.', 'um … zu bleiben'),
    qsi('Er nahm ein Taxi, um pünktlich zu ____. (sein)', 'sein',
        'He took a taxi in order to be on time.', 'um … zu sein'),
    qsi('Ich rufe an, um einen Termin zu ____. (vereinbaren)', 'vereinbaren',
        'I am calling to arrange an appointment.', 'um … zu vereinbaren'),
    qsi('Sie fuhr los, ohne sich zu ____. (verabschieden)', 'verabschieden',
        'She left without saying goodbye.', 'ohne … zu verabschieden'),
    qsi('Er kaufte das Handy, ohne den Preis zu ____. (vergleichen)',
        'vergleichen', 'He bought the phone without comparing the price.',
        'ohne … zu vergleichen'),
    qsi('Statt zu ____, ging sie zu Fuß. (fahren)', 'fahren',
        'Instead of driving, she walked.', 'statt … zu fahren'),
    qsi('Wir sparen, um im Sommer zu ____. (verreisen)', 'verreisen',
        'We save in order to travel in the summer.', 'um … zu verreisen'),
    qsi('Ich brauche eine Brille, um besser zu ____. (sehen)', 'sehen',
        'I need glasses in order to see better.', 'um … zu sehen'),
    qsi('Er ging vorbei, ohne uns zu ____. (grüßen)', 'grüßen',
        'He walked past without greeting us.', 'ohne … zu grüßen',
        accepted: ['gruessen']),
    qsi('Statt zu ____, hörte er Musik. (arbeiten)', 'arbeiten',
        'Instead of working, he listened to music.', 'statt … zu arbeiten'),
  ],
);
...
final QuizContent questB12RelativDatContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Der Freund, ____ ich das Buch leihe, ist krank. (Dativ m)', 'dem',
        'The friend I lend the book to is ill.', 'dem (leihen)'),
    qsi('Die Kollegin, mit ____ ich arbeite, ist nett. (mit + Dativ f)', 'der',
        'The colleague I work with is nice.', 'mit der'),
    qsi('Das Kind, ____ das Eis schmeckt, lacht. (Dativ n)', 'dem',
        'The child who likes the ice cream laughs.', 'dem (schmecken)'),
    qsi('Die Nachbarn, bei ____ wir wohnen, sind leise. (bei + Dativ Pl.)',
        'denen', 'The neighbours we live with are quiet.', 'bei denen'),
    qsi('Der Tisch, an ____ wir essen, ist sehr alt. (an + Dativ m)', 'dem',
        'The table we eat at is very old.', 'an dem'),
    qsi('Die Frau, ____ Hund bellt, wohnt oben. (Genitiv f)', 'deren',
        'The woman whose dog barks lives upstairs.', 'deren (Genitiv f)'),
    qsi('Die Stadt, in ____ ich geboren wurde, ist klein. (in + Dativ f)',
        'der', 'The city I was born in is small.', 'in der'),
    qsi('Der Kollege, von ____ ich erzählte, kommt morgen. (von + Dativ m)',
        'dem', 'The colleague I told you about comes tomorrow.', 'von dem'),
    qsi('Die Kinder, ____ Eltern arbeiten, essen in der Schule. (Genitiv Pl.)',
        'deren', 'The children whose parents work eat at school.',
        'deren (Pl.)'),
    qsi('Das Dorf, aus ____ er kommt, liegt in Bayern. (aus + Dativ n)', 'dem',
        'The village he comes from is in Bavaria.', 'aus dem'),
  ],
);
