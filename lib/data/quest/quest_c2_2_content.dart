...
final QuizContent questC22PhilosophieContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('Das menschliche ____ bleibt ein Rätsel. (consciousness)',
        ...
        'consciousness'),
    qsi('Kants Werk prägt die abendländische ____. (philosophy)',
        'Philosophie', 'Kant\'s work shapes Western philosophy.',
        'philosophy'),
    qsi('Jede ____ braucht eine Begründung. (assertion)', 'Behauptung',
        'Every assertion needs a justification.', 'assertion'),
    qsi('Die Ethik fragt nach dem richtigen ____. (conduct/action)', 'Handeln',
        'Ethics asks about right conduct.', 'conduct'),
    qsi('Der ____ zwischen Freiheit und Sicherheit bleibt. (conflict)',
        'Konflikt', 'The conflict between freedom and security remains.',
        'conflict'),
    qsi('Die ____ ist die Lehre vom Erkennen. (epistemology)',
        'Erkenntnistheorie', 'Epistemology is the theory of knowledge.',
        'epistemology'),
    qsi('Ohne ____ gibt es keine Schuld. (free will)', 'Willensfreiheit',
        'Without free will there is no guilt.', 'free will'),
    qsi('Der Zweck heiligt nicht die ____. (means)', 'Mittel',
        'The end does not justify the means.', 'means'),
    qsi('Die Würde des Menschen ist ____. (inviolable)', 'unantastbar',
        'Human dignity is inviolable.', 'inviolable'),
    qsi('Jede Epoche hat ihr eigenes ____. (view of humanity)', 'Menschenbild',
        'Every era has its own view of humanity.', 'view of humanity'),
    qsi('Skeptiker stellen jede ____ in Frage. (certainty)', 'Gewissheit',
        'Sceptics question every certainty.', 'certainty'),
  ],
);
...
final QuizContent questC22FokusContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('____ ein Wort kann alles ändern. (just/already one)', 'Schon',
        'Just one word can change everything.', 'schon (ein Wort)'),
    qsi('____ die Idee finde ich spannend. (the … alone)', 'Allein',
        'The idea alone I find exciting.', 'allein (Idee)'),
    qsi('____ am Wochenende habe ich Zeit. (only)', 'Nur',
        'Only at the weekend do I have time.', 'nur (Wochenende)'),
    qsi('____ nach Jahren verstand ich es. (only after)', 'Erst',
        'Only after years did I understand it.', 'erst (nach Jahren)'),
    qsi('____ gestern habe ich ihn gesehen. (only yesterday)', 'Erst',
        'Only yesterday did I see him.', 'erst (gestern)'),
    qsi('____ die Kinder haben es bemerkt. (even)', 'Sogar',
        'Even the children noticed it.', 'sogar'),
    qsi('Diesen Satz habe ____ ich nicht verstanden. (even I)', 'selbst',
        'Even I did not understand this sentence.', 'selbst (ich)'),
    qsi('____ ihm hätte ich das nicht zugetraut. (him of all people)',
        'Ausgerechnet', 'Him of all people — I would not have expected it.',
        'ausgerechnet (ihm)'),
    qsi('____ dieses Detail macht den Unterschied. (precisely)', 'Gerade',
        'Precisely this detail makes the difference.', 'gerade (Detail)'),
    qsi('____ du solltest das verstehen. (you of all people)', 'Gerade',
        'You of all people should understand that.', 'gerade (du)'),
  ],
);
...
final QuizContent questC22AnspielungContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('„Interessante Frisur!" kann versteckter ____ sein. (mockery)',
        'Spott', 'Can be hidden mockery.', 'Spott'),
    qsi('„Wir sollten mal wieder telefonieren." ist oft nur eine höfliche '
        '____. (empty phrase)', 'Floskel',
        'Often just a polite empty phrase.', 'Floskel'),
    qsi('„Hast du eine Uhr?" meint eigentlich: Wie spät ist ____? (it)', 'es',
        'Really means: what time is it?', 'indirect question'),
    qsi('„Das war wohl nichts." meint: Es ist ____. (failed)', 'gescheitert',
        'Means: it failed.', 'understatement (gescheitert)'),
    qsi('„Mach dir keinen Kopf!" meint: Mach dir keine ____. (worries)',
        'Sorgen', 'Means: don\'t worry.', 'idiom (Sorgen)'),
    qsi('„Schön, dass du auch schon da bist." (zu spät) ist ____. (irony)',
        'Ironie', 'Said to a latecomer: irony.', 'Ironie (spät)'),
    qsi('„Ich sage nur: Montag!" spielt auf etwas gemeinsam ____ an. (known)',
        'Bekanntes', 'Alludes to something both know.', 'Anspielung'),
    qsi('„Er ist kein großer Redner." meint: Er redet ____. (badly)',
        'schlecht', 'Means: he speaks badly (litotes).', 'litotes (schlecht)'),
    qsi('„Darüber müssen wir reden." kündigt oft ein ____ an. (problem)',
        'Problem', 'Often announces a problem.', 'implied problem'),
    qsi('„Nett hier." bei langem Schweigen überspielt oft ____. '
        '(awkwardness)', 'Verlegenheit',
        'Often covers up awkwardness.', 'Verlegenheit'),
  ],
);
...
final QuizContent questC22ParaphraseContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('„helfen" gehoben: ____ leisten (assistance)', 'Beistand',
        'help → render assistance', 'Beistand leisten'),
    qsi('„sich freuen" gehoben: ____ empfinden (feel joy)', 'Freude',
        'be glad → feel joy', 'Freude empfinden'),
    qsi('„beginnen" nominal: den ____ machen (make a start)', 'Anfang',
        'begin → make a start', 'den Anfang machen'),
    qsi('„entscheiden" nominal: eine ____ fällen (reach a decision)',
        'Entscheidung', 'decide → reach a decision', 'Entscheidung fällen'),
    qsi('„antworten" nominal: ____ geben (give an answer)', 'Antwort',
        'answer → give an answer', 'Antwort geben'),
    qsi('„sterben" gehoben: ums Leben ____ (lose one\'s life)', 'kommen',
        'die → lose one\'s life', 'ums Leben kommen'),
    qsi('„erlauben" gehoben: die ____ erteilen (grant permission)',
        'Erlaubnis', 'allow → grant permission', 'Erlaubnis erteilen'),
    qsi('„sehr" gehoben: in hohem ____ (to a high degree)', 'Maße',
        'very → to a high degree', 'in hohem Maße',
        accepted: ['Masse']),
    qsi('„oft" gehoben: in vielen ____ (in many cases)', 'Fällen',
        'often → in many cases', 'in vielen Fällen',
        accepted: ['Faellen']),
    qsi('„am Ende" gehoben: ____ (ultimately)', 'letztlich',
        'in the end → ultimately', 'letztlich'),
  ],
);
...
final QuizContent questC22WortspielContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('„die Birne" kann ein Obst oder eine ____ sein. (light bulb)',
        'Glühbirne', 'a pear or a light bulb', 'Birne (homonym)',
        accepted: ['Gluehbirne']),
    qsi('„der Läufer" ist ein Sportler oder eine ____. (chess piece)',
        'Schachfigur', 'a runner or a chess piece (bishop)',
        'Läufer (homonym)'),
    qsi('„die Maus" ist ein Tier — oder gehört zum ____. (computer)',
        'Computer', 'a mouse (animal) or a computer mouse', 'Maus (homonym)'),
    qsi('„der Hahn" kann ein Vogel oder ein ____ sein. (water tap)',
        'Wasserhahn', 'a rooster or a water tap', 'Hahn (homonym)'),
    qsi('„das Gericht" kann ein Essen oder ein ____ sein. (court of law)',
        'Gericht', 'a dish or a court of law', 'Gericht (homonym)'),
    qsi('„die Leiter" (f) ist ein Gerät, „der Leiter" (m) ein ____. (boss)',
        'Chef', 'a ladder (f) vs a manager (m)', 'Leiter (Genus)'),
    qsi('„der See" ist ein Gewässer, „die See" ist das ____. (the sea)',
        'Meer', 'lake (m) vs sea (f)', 'See (Genus)'),
    qsi('„das Tor" kann ein Fußballtor oder ein großes ____ sein. (gate)',
        'Tor', 'a goal or a gate', 'Tor (homonym)'),
    qsi('„die Mutter" ist ein Elternteil oder gehört zur ____. (screw)',
        'Schraube', 'a mother or a (screw) nut', 'Mutter (homonym)'),
    qsi('„der Strauß" kann ein Vogel oder ein ____ sein. (bouquet)',
        'Blumenstrauß', 'an ostrich or a bouquet', 'Strauß (homonym)',
...
final QuizContent questC22WissenschaftsspracheContent = sentenceQuestQuiz(
  ...
  items: [
    ...
    qsi('In ____ auf frühere Arbeiten zeigt sich … (with reference to)',
        ...
        'in Bezug auf'),
    qsi('Die These lässt sich wie folgt ____. (summarise)', 'zusammenfassen',
        'The thesis can be summarised as follows.', 'zusammenfassen'),
    qsi('Der Begriff ist zunächst zu ____. (define)', 'definieren',
        'The term must first be defined.', 'definieren'),
    qsi('Im ____ zu Kapitel zwei zeigt sich ein anderes Bild. '
        '(in contrast to)', 'Gegensatz',
        'In contrast to chapter two a different picture emerges.',
        'im Gegensatz zu'),
    qsi('Die Daten ____ die Hypothese. (support)', 'stützen',
        'The data support the hypothesis.', 'stützen',
        accepted: ['stuetzen']),
    qsi('Unter ____ der Fehlerquote gilt das Ergebnis. '
        '(taking into account)', 'Berücksichtigung',
        'Taking the error rate into account, the result holds.',
        'unter Berücksichtigung', accepted: ['Beruecksichtigung']),
    qsi('Dies gilt es im Folgenden zu ____. (examine)', 'untersuchen',
        'This is to be examined in what follows.', 'zu untersuchen'),
    qsi('Die Ergebnisse sind vorsichtig zu ____. (interpret)',
        'interpretieren', 'The results are to be interpreted with caution.',
        'interpretieren'),
    qsi('Der Autor ____ sich auf neuere Studien. (refers to)', 'bezieht',
        'The author refers to more recent studies.', 'sich beziehen auf'),
    qsi('Abschließend lässt sich ____, dass die These trägt. (state)',
        'festhalten', 'In conclusion it can be stated that the thesis holds.',
        'festhalten'),
    qsi('Dieser Aspekt bedarf weiterer ____. (investigation)', 'Untersuchung',
