...
/// Joins a label's translations for the pre-selection state, e.g.
/// "I speak · Hablo · Ich spreche · 我说".
String _tri(Map<UiLang, String> m) =>
    '${m[UiLang.en]}  ·  ${m[UiLang.es]}  ·  ${m[UiLang.de]}  ·  ${m[UiLang.zh]}';
                      ...
                      child: Column(
                        children: [
                          ...
                          if (uiLang == null) ...[
                            ...
                            Text(
                              '${_titleText[UiLang.es]} · ${_titleText[UiLang.de]} · ${_titleText[UiLang.zh]}',
                              textAlign: TextAlign.center,
